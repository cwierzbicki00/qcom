#ifndef __QCC74x_HCI_UART_H
#define __QCC74x_HCI_UART_H
...
typedef void (*qcc74x_hci_rx_ptr)(struct net_buf* rx_buf);
typedef struct net_buf* (*qcc74x_hci_alloc_buf_ptr)(uint8_t rx_type, uint8_t sub_evt, uint16_t len);

typedef struct _qcc74x_hci_trans_callbacks_t
{
  qcc74x_hci_rx_ptr            rx_handler;
  qcc74x_hci_alloc_buf_ptr     alloc_buf;
}qcc74x_hci_trans_callbacks_t;
