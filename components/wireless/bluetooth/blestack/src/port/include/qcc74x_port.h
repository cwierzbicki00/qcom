#ifndef QCC74x_PORT_H
#define QCC74x_PORT_H
...
#define QCC74x_WAIT_FOREVER    0xffffffffu
#define QCC74x_NO_WAIT         0x0
...
typedef qcc74x_hdl_t _queue_t;
typedef qcc74x_hdl_t  _sem_t;
typedef uint32_t _stack_element_t;
typedef qcc74x_hdl_t  _mutex_t;
typedef qcc74x_hdl_t qcc74x_timer_t;
