...
#define CONFIG_BT_DEVICE_NAME "QCC74x_undef-BLE-DEV"
#elif defined(QCC74x_undef)
#define CONFIG_BT_DEVICE_NAME "QCC74x_undef-BLE-DEV"
#elif defined(QCC74x_undefL)
#define CONFIG_BT_DEVICE_NAME "QCC74x_undefL-BLE-DEV"
#else
...
#if defined(QCC74x_undef)
#define CONFIG_BT_CONTROLLER_NAME "QCC74x_undef-BLE-DEV"
#else
#define CONFIG_BT_CONTROLLER_NAME "QCC74x_undef-BLE-DEV"
#endif
#endif
...
#define QCC74x_BT_LINK_KEYS_STORE
#if defined(QCC74x_undef) || defined(QCC74x_undefL)
#if defined(CFG_BLE_PDS) && defined(QCC74x_BLE) && defined(QCC74x_DYNAMIC_ALLOC_MEM)&& !defined(CONFIG_BT_MESH)
#define QCC74x_STATIC_ALLOC_MEM   1
#else
#define QCC74x_STATIC_ALLOC_MEM   0
#endif
#else
#define QCC74x_STATIC_ALLOC_MEM   0
#endif
...
#undef QCC74x_FIXED_IRK
#define QCC74x_FIXED_IRK 1
#endif
...
#define QCC74x_BLE_PATCH_DHKEY_CHECK_FAILED
/*To notify upper layer that write_ccc is completed*/
#define QCC74x_BLE_PATCH_NOTIFY_WRITE_CCC_RSP
...
#define QCC74x_BLE_PATCH_FREE_ALLOCATED_BUFFER_IN_OS
/*To avoid duplicated pubkey callback.*/
#define QCC74x_BLE_PATCH_AVOID_DUPLI_PUBKEY_CB
/*Cancle att->timeout work if att_req is cancelled to avoid att timeout.*/
#define QCC74x_BLE_PATCH_CANCEL_ATT_TIMEOUT_TIMER_WHEN_ATT_REQ_CANCELLED
...
#define QCC74x_BLE_PATCH_SET_SCRANGE_CHAGD_ONLY_IN_CONNECTED_STATE
#endif
...
#define QCC74x_BLE_PATCH_SETTINGS_LOAD
#endif
#define QCC74x_BLE_PATCH_AVOID_CONN_UPDATE_WHEN_PREVIOUS_IS_NOT_OVER
#ifdef CONFIG_BT_SMP
#define QCC74x_BLE_SMP_LOCAL_AUTH
#define QCC74x_BLE_SMP_SUPPORT_DISABLE_PAIR
#endif
#define QCC74x_BLE_MTU_CHANGE_CB
#if defined(CONFIG_BT_GAP_PERIPHERAL_PREF_PARAMS)
#define QCC74x_BLE_GAP_SET_PERIPHERAL_PREF_PARAMS
#endif

#if defined(CFG_BT_RESET)
#define QCC74x_HOST_ASSISTANT
#endif

#define QCC74x_RELEASE_CMD_SEM_IF_CONN_DISC
...
#define QCC74x_BLE_PATCH_CLEAR_REMOTE_KEY_BIT

#if defined(CONFIG_BT_CENTRAL) || defined(CONFIG_BT_OBSERVER)
#if defined(QCC74x_undef) || defined(QCC74x_undef)
#define QCC74x_BLE_NOTIFY_ADV_DISCARDED
#endif
#endif

#if defined(CONFIG_BT_CENTRAL)
#define QCC74x_BLE_NOTIFY_ALL
#define QCC74x_BLE_DISCOVER_ONGOING
#endif

#define QCC74x_BLE_SET_LOCAL_ATT_MTU_SIZE
#if defined(CONFIG_BT_SMP)
#define QCC74x_BLE_SMP_SC_ONLY
#endif
...
#define QCC74x_BLE_PATCH_ADD_ERRNO_IN_DISCOVER_CALLBACK
#define QCC74x_BLE_PATCH_NOT_DO_TX_IF_DISCONNECTED
 ...
 */
#define QCC74x_BLE_PATCH_CLEAR_UNBONDED_DEVICE_SC_WHEN_DISCONNECTED
 ...
 */
#define QCC74x_BLE_PATCH_DO_GATT_CLEAR_IF_UNPAIRED
#define QCC74x_BLE_PATCH_SC_CFG_FAIL_TO_BE_REMOVED_FROM_FLASH
#define QCC74x_BLE_PATCH_AVOID_NEXT_ATT_REQ_SENT_BEFORE_PREVIOUS_ATT_RSP_RCVD
 ...
 * bt_conn_unref because conn->ref is reduced when uppper layer calls bt_conn_disconnect at the first time.
*/
#define QCC74x_BLE_PATCH_AVOID_CONNECT_DISCONNECT_RISK
...
*/
#define QCC74x_BLE_PATCH_FIX_CONN_STATE_CHANGE_RISK
#define QCC74x_BLE_PATCH_FREE_CONN_UPDATE_WORK_WHEN_CANCEL_CONN_IN_CONNECT_STATE
...
*/
#define QCC74x_BLE_NOT_FORCE_WRITE_CCC_FOR_EXISTED_SUBSCRIPTIONS_IN_STACK
#if defined (CONFIG_BT_GAP_PERIPHERAL_PREF_PARAMS)
