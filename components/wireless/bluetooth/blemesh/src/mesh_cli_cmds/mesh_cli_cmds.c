...
#include "qcc74x_ble_mesh_lighting_model_api.h"
#endif
#include "qcc74x_ble_mesh_local_data_operation_api.h"
...
#include "qcc74xsync_ble_app.h" // added blemesh sync 
#endif
...
#if defined(CONFIG_BT_MESH_MODEL)
#if defined(CONFIG_BT_MESH_MODEL_GEN_SRV)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(onoff_pub, 2 + 3, ROLE_NODE);
static qcc74x_ble_mesh_gen_onoff_srv_t onoff_server = {
...
#if defined(CONFIG_BT_MESH_MODEL_GEN_CLI)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(onoff_cli_pub, 2 + 1, ROLE_NODE);
static qcc74x_ble_mesh_client_t onoff_client;
#endif

#if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(lightness_pub, 2 + 5, ROLE_NODE);
static qcc74x_ble_mesh_light_lightness_state_t lightness_state;
static qcc74x_ble_mesh_light_lightness_srv_t lightness_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(lightness_cli_pub, 2 + 1, ROLE_NODE);
static qcc74x_ble_mesh_client_t lightness_client;
#endif
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(ctl_cli_pub, 2 + 1, ROLE_NODE);
static qcc74x_ble_mesh_client_t ctl_client;
#endif

#if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(hsl_pub, 2 + 9, ROLE_NODE);
static qcc74x_ble_mesh_light_hsl_state_t hsl_state;
static qcc74x_ble_mesh_light_hsl_srv_t hsl_server = {
	.rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
	.rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
	.state = &hsl_state,
};
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(hsl_cli_pub, 2 + 1, ROLE_NODE);
static qcc74x_ble_mesh_client_t hsl_client;
#endif
...
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(level_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_level_srv_t level_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(onoff_pub_2, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_onoff_srv_t onoff_server_2 = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(level_pub_2, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_level_srv_t level_server_2 = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(def_trans_time_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_def_trans_time_srv_t def_trans_time_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_onoff_pub, MESH_MSG_LEN, ROLE_NODE);
qcc74x_ble_mesh_gen_onpowerup_state_t onpowerup_state;
static qcc74x_ble_mesh_gen_power_onoff_srv_t power_onoff_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &onpowerup_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_onoff_setup_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_power_onoff_setup_srv_t power_onoff_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &onpowerup_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_level_pub, MESH_MSG_LEN, ROLE_NODE);
qcc74x_ble_mesh_gen_power_level_state_t power_level_state;
static qcc74x_ble_mesh_gen_power_level_srv_t power_level_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &power_level_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_level_setup_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_power_level_setup_srv_t power_level_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &power_level_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(battery_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_battery_srv_t battery_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(location_pub, MESH_MSG_LEN, ROLE_NODE);
qcc74x_ble_mesh_gen_location_state_t location_state;
static qcc74x_ble_mesh_gen_location_srv_t location_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &location_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(location_setup_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_location_setup_srv_t location_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &location_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(user_prop_pub, MESH_MSG_LEN, ROLE_NODE);
...
qcc74x_ble_mesh_generic_property_t property = {
    .id = 1,
...
static qcc74x_ble_mesh_gen_user_prop_srv_t user_prop_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .property_count = 1,
    .properties = &property,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(admin_prop_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_admin_prop_srv_t admin_prop_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .property_count = 1,
    .properties = &property,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(manu_prop_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_gen_manu_prop_srv_t manu_prop_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .property_count = 1,
    .properties = &property,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(client_prop_pub, MESH_MSG_LEN, ROLE_NODE);
uint16_t property_ids;
static qcc74x_ble_mesh_gen_client_prop_srv_t client_prop_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .id_count = 1,
...
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_ctl_setup_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_ctl_setup_srv_t light_ctl_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &light_ctl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_ctl_temp_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_ctl_temp_srv_t light_ctl_temp_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &light_ctl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_hsl_setup_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_hsl_setup_srv_t light_hsl_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &hsl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_hsl_hue_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_hsl_hue_srv_t light_hsl_hue_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &hsl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_hsl_sat_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_hsl_sat_srv_t light_hsl_sat_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &hsl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_xyl_setup_pub, MESH_MSG_LEN, ROLE_NODE);
qcc74x_ble_mesh_light_xyl_state_t light_xyl_state;
static qcc74x_ble_mesh_light_xyl_setup_srv_t light_xyl_setup_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &light_xyl_state,
};
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_xyl_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_light_xyl_srv_t light_xyl_server = {
    .rsp_ctrl.get_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .rsp_ctrl.set_auto_rsp = QCC74x_BLE_MESH_SERVER_AUTO_RSP,
    .state = &light_xyl_state,
};
...
static qcc74x_ble_mesh_client_t def_trans_time_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_onoff_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t power_onoff_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(power_level_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t power_level_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(battery_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t battery_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(location_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t location_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(property_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t property_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_xyl_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t light_xyl_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_lc_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t light_lc_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_ctl_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t light_ctl_client;
QCC74x_BLE_MESH_MODEL_PUB_DEFINE(light_hsl_cli_pub, MESH_MSG_LEN, ROLE_NODE);
static qcc74x_ble_mesh_client_t light_hsl_client;
#endif
static struct bt_mesh_model sig_models[] = {
	...
	QCC74x_BLE_MESH_MODEL_GEN_ONOFF_SRV(&onoff_pub, &onoff_server),
	QCC74x_BLE_MESH_MODEL_GEN_LEVEL_SRV(&level_pub, &level_server),
	QCC74x_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SRV(&lightness_pub, &lightness_server),
	QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_SRV(&def_trans_time_pub, &def_trans_time_server),
	QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SRV(&power_onoff_pub, &power_onoff_server),
        QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SETUP_SRV(&power_onoff_setup_pub, &power_onoff_setup_server),
        QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SRV(&power_level_pub, &power_level_server),
        QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SETUP_SRV(&power_level_setup_pub, &power_level_setup_server),
        QCC74x_BLE_MESH_MODEL_GEN_BATTERY_SRV(&battery_pub, &battery_server),
        QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SRV(&location_pub, &location_server),
        QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SETUP_SRV(&location_setup_pub, &location_setup_server),
        QCC74x_BLE_MESH_MODEL_GEN_USER_PROP_SRV(&user_prop_pub, &user_prop_server),
        QCC74x_BLE_MESH_MODEL_GEN_ADMIN_PROP_SRV(&admin_prop_pub, &admin_prop_server),
        QCC74x_BLE_MESH_MODEL_GEN_MANUFACTURER_PROP_SRV(&manu_prop_pub, &manu_prop_server),
        QCC74x_BLE_MESH_MODEL_GEN_CLIENT_PROP_SRV(&client_prop_pub, &client_prop_server),

	QCC74x_BLE_MESH_MODEL_GEN_ONOFF_CLI(&onoff_cli_pub, &onoff_client),
	QCC74x_BLE_MESH_MODEL_GEN_LEVEL_CLI(&level_cli_pub, &level_client),
	QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_CLI(&def_trans_time_cli_pub, &def_trans_time_client),
        QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_CLI(&power_onoff_cli_pub, &power_onoff_client),
        QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_CLI(&power_level_cli_pub, &power_level_client),
        QCC74x_BLE_MESH_MODEL_GEN_BATTERY_CLI(&battery_cli_pub, &battery_client),
        QCC74x_BLE_MESH_MODEL_GEN_LOCATION_CLI(&location_cli_pub, &location_client),
        QCC74x_BLE_MESH_MODEL_GEN_PROPERTY_CLI(&property_cli_pub, &property_client),

        QCC74x_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SRV(&lightness_pub, &lightness_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_LIGHTNESS_SETUP_SRV(&lightness_setup_pub, &lightness_setup_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_CTL_SRV(&ctl_pub, &ctl_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_CTL_SETUP_SRV(&light_ctl_setup_pub, &light_ctl_setup_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_CTL_TEMP_SRV(&light_ctl_temp_pub, &light_ctl_temp_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_HSL_SRV(&hsl_pub, &hsl_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_HSL_SETUP_SRV(&light_hsl_setup_pub, &light_hsl_setup_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_HSL_HUE_SRV(&light_hsl_hue_pub, &light_hsl_hue_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_HSL_SAT_SRV(&light_hsl_sat_pub, &light_hsl_sat_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_XYL_SRV(&light_xyl_pub, &light_xyl_server),
        QCC74x_BLE_MESH_MODEL_LIGHT_XYL_SETUP_SRV(&light_xyl_setup_pub, &light_xyl_setup_server),
    
   
	QCC74x_BLE_MESH_MODEL_LIGHT_LIGHTNESS_CLI(&lightness_cli_pub, &lightness_client),
	QCC74x_BLE_MESH_MODEL_LIGHT_CTL_CLI(&light_ctl_cli_pub, &light_ctl_client),
	QCC74x_BLE_MESH_MODEL_LIGHT_HSL_CLI(&light_hsl_cli_pub, &light_hsl_client),
	QCC74x_BLE_MESH_MODEL_LIGHT_XYL_CLI(&light_xyl_cli_pub, &light_xyl_client),
#endif
#else
    ...
    #endif
    #if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
	QCC74x_BLE_MESH_MODEL_LIGHT_CTL_CLI(&ctl_cli_pub, &ctl_client),
    #endif
    #if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
	QCC74x_BLE_MESH_MODEL_LIGHT_HSL_SRV(&hsl_pub, &hsl_server),
    #endif
    #if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
	QCC74x_BLE_MESH_MODEL_LIGHT_HSL_CLI(&hsl_cli_pub, &hsl_client),
    #endif
#endif /* CONFIG_BT_MESH_MODEL */
...
static struct bt_mesh_model vendor_models[] = {
	BT_MESH_MODEL_VND(QCC74x_COMP_ID, BT_MESH_VND_MODEL_ID_DATA_SRV, vendor_data_op, NULL, &vendor_data),
#if defined(CONFIG_BT_MESH_MODEL_VENDOR_CLI)
	BT_MESH_MODEL_VND(QCC74x_COMP_ID, BT_MESH_VND_MODEL_ID_DATA_CLI, vendor_data_op_cli, NULL, &vendor_data_cli),
#endif /*CONFIG_BT_MESH_MODEL_VENDOR_CLI*/
#if defined(CONFIG_BT_MESH_SYNC)
	QCC74x_BLE_MESH_MODEL_VND_SYNC_SRV(),
#endif
};
#if defined(CONFIG_BT_MESH_PTS) || defined(CONFIG_AUTO_PTS)
...
#else
#if defined(QCC74x_undef) || defined(QCC74x_undef) || defined(QCC74x_undefP) || defined(QCC74x_undefL)
...
static void gen_props_get(uint8_t *data, uint16_t len)
{
    ...
    case 0:/*mfr_props*/
        ...
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_GET;
        break;
    case 1:/*admin_props*/
        get_state.admin_property_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_GET;
        break;
    case 2:/*usr_props*/
        get_state.user_property_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_GET;
        break;
    case 3:/*cli_props*/
        get_state.client_properties_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_GET;
        break;
    default:
        return;
        break;
    ...
    const struct bt_mesh_comp *mesh_comp = bt_mesh_comp_get();
    for(int i = 0; i < mesh_comp->elem_count; ++i){
        mesh_model = bt_mesh_model_find(&mesh_comp->elem[i], QCC74x_BLE_MESH_MODEL_ID_GEN_PROP_CLI);
        if(mesh_model != NULL){
            break;
        }
    }
    ...
    client_common.model = mesh_model;
    client_common.opcode = opcode,
    qcc74x_ble_mesh_generic_client_get_state(&client_common, &get_state);
}
static void gen_prop_get(uint8_t *data, uint16_t len)
{
    ...
    case 0:/*mfr_props*/
        get_state.manufacturer_property_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_GET;
        break;
    case 1:/*admin_props*/
        get_state.admin_property_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_GET;
        break;
    case 2:/*usr_props*/
        get_state.user_property_get.property_id = property_id;
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_GET;
        break;
    default:
        return;
        break;
...
static void gen_prop_set(uint8_t *data, uint16_t len)
{
    ...
    switch(data[1]){
    case 0:/*mfr_props*/
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET_UNACK;
        ...
        break;
    case 1:/*admin_props*/
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET_UNACK;
        ...
        break;
    case 2:/*usr_props*/
        opcode = QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET_UNACK;
    ...
    common_set(QCC74x_BLE_MESH_MODEL_ID_GEN_PROP_CLI, opcode, data[0], &gen_client_set);
}
...
static void pts_tester_handle_mesh_model(u32_t opcode, uint8_t *data, uint16_t len)
{
    ...
    case QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_GET:{gen_props_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_GET:{gen_props_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_GET:{gen_props_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_GET:{gen_prop_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_GET:{gen_prop_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_GET:{gen_prop_get(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET_UNACK:{gen_prop_set(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET_UNACK:{gen_prop_set(data, len);}break;
    case QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET_UNACK:{gen_prop_set(data, len);}break;
...
static void mmdl_generic_server_cb(qcc74x_ble_mesh_generic_server_cb_event_t event,
                                               qcc74x_ble_mesh_generic_server_cb_param_t *param)
{
    ...
    lctl_srv = (qcc74x_ble_mesh_light_ctl_srv_t*)lctl_m->user_data;
    ...
    //qcc74x_ble_mesh_gen_onoff_srv_t *srv;
    BT_WARN("event 0x%02x, opcode 0x%04lx, src 0x%04x, dst 0x%04x\n",
        event, param->ctx.recv_op, param->ctx.addr, param->ctx.recv_dst);

    switch (event) {
    case QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT:{
        BT_WARN("QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT\n");
        switch(param->ctx.recv_op) {
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK:{
        ...
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_SET_UNACK:
            ...
            gen_level_publish(gl_m);
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET_UNACK:
        ...
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET_UNACK:{
        ...
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET_UNACK:{
        ...
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET_UNACK:{
            BT_WARN("GEN_POWER_DEFAULT_SET [%x]\n", param->value.state_change.power_default_set.power);
        }
        break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET:
        case QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET_UNACK:{
...
static void mmdl_lighting_server_cb(qcc74x_ble_mesh_lighting_server_cb_event_t event,
           qcc74x_ble_mesh_lighting_server_cb_param_t *param)
{
    const struct bt_mesh_comp *mesh_comp = bt_mesh_comp_get();
    ...
    switch (event) {
    case QCC74x_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT:
        BT_WARN("QCC74x_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT\n");
        if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LINEAR_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_LINEAR_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_DEFAULT_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_DEFAULT_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_RANGE_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_TEMPERATURE_RANGE_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_HUE_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_HUE_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SATURATION_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SATURATION_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_DEFAULT_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_DEFAULT_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_RANGE_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_RANGE_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_DEFAULT_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_DEFAULT_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_RANGE_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_XYL_RANGE_SET_UNACK) {
        ...
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LC_OM_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LC_OM_SET_UNACK) {
            BT_WARN("LIGHT_LC_OM_SET [%x]\n",
                param->value.state_change.lc_om_set.mode);
            //state_machine_om(&lc_srv->lc->state_machine.state,
            //    param->value.state_change.lc_om_set.mode);
        }
        else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_SET_UNACK) {
        ...
        qcc74x_ble_mesh_generic_client_cb_param_t *param)
{
    ...
    case QCC74x_BLE_MESH_GENERIC_CLIENT_GET_STATE_EVT: {
        switch (opcode) {
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_GET:{
            qcc74x_ble_mesh_gen_onoff_status_cb_t* onoff_status;
            onoff_status = &param->status_cb.onoff_status;
            if (param->error_code == QCC74x_OK) {
                BT_WARN("GEN_ONOFF_GET:OK[%x]\n", onoff_status->present_onoff);
            } else {
                BT_WARN("GEN_ONOFF_GET:Fail[%x]\n", param->error_code);
            }
        }break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_GET:{
            qcc74x_ble_mesh_gen_level_status_cb_t* level_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_GET:{
            qcc74x_ble_mesh_gen_def_trans_time_status_cb_t* def_trans_time_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_GET:{
            qcc74x_ble_mesh_gen_onpowerup_status_cb_t* onpowerup_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_GET:{
            qcc74x_ble_mesh_gen_power_level_status_cb_t* power_level_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LAST_GET:{
            qcc74x_ble_mesh_gen_power_last_status_cb_t* power_last_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_GET:{
            qcc74x_ble_mesh_gen_power_default_status_cb_t* power_default_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_GET:{
            qcc74x_ble_mesh_gen_power_range_status_cb_t* power_range_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_BATTERY_GET:{
            qcc74x_ble_mesh_gen_battery_status_cb_t* battery_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_GET:{
            qcc74x_ble_mesh_gen_loc_global_status_cb_t* location_global_status;
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_GET:{
            qcc74x_ble_mesh_gen_loc_local_status_cb_t* location_local_status;
        ...
        {
            qcc74x_ble_mesh_gen_user_properties_status_cb_t* user_properties_status;
        ...
        {
            qcc74x_ble_mesh_gen_user_property_status_cb_t* user_property_status;
    ...
    case QCC74x_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT: {
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_SET:
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_DELTA_SET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_MOVE_SET:
            if (param->error_code == QCC74x_OK) {
        ...
        case QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET:
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_SET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_SET:
            if (param->error_code == QCC74x_OK) {
    ...
    case QCC74x_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT: {
        if (param->error_code == QCC74x_OK) {
            switch (opcode) {
                case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS:
    ...
    case QCC74x_BLE_MESH_GENERIC_CLIENT_TIMEOUT_EVT:
        ...
        break;
    case QCC74x_BLE_MESH_GENERIC_CLIENT_EVT_MAX:
...
void mmdl_light_client_cb(qcc74x_ble_mesh_light_client_cb_event_t event,
        qcc74x_ble_mesh_light_client_cb_param_t *param)
{
    uint32_t opcode = param->params->opcode;
...
static uint8_t models_callback_init(void)
{
    ...
    size_t ret;
    /* For server */
    err = qcc74x_ble_mesh_register_generic_server_callback(mmdl_generic_server_cb);
    if(err != QCC74x_OK){
        return err;
    }
    err = qcc74x_ble_mesh_register_lighting_server_callback(mmdl_lighting_server_cb);
    if(err != QCC74x_OK){
        return err;
    }

    /* For client */
    err = qcc74x_ble_mesh_register_generic_client_callback(mmdl_generic_client_cb);
    if(err != QCC74x_OK){
        return err;
    }
    err = qcc74x_ble_mesh_register_light_client_callback(mmdl_light_client_cb);
    if(err != QCC74x_OK){
        return err;
    }
    ...
    gl_m = bt_mesh_model_find(&elements[0], QCC74x_BLE_MESH_MODEL_ID_GEN_LEVEL_SRV);
    gl_srv = (qcc74x_ble_mesh_gen_level_srv_t*)gl_m->user_data;
    lctl_m = bt_mesh_model_find(&elements[0], QCC74x_BLE_MESH_MODEL_ID_LIGHT_CTL_SRV);
    lctl_srv = (qcc74x_ble_mesh_light_ctl_srv_t*)lctl_m->user_data;
    ...
    gl_m = bt_mesh_model_find(&elements[0], QCC74x_BLE_MESH_MODEL_ID_GEN_LEVEL_SRV);
    gl_srv = (qcc74x_ble_mesh_gen_level_srv_t*)gl_m->user_data;
    lhsl_m = bt_mesh_model_find(&elements[0], QCC74x_BLE_MESH_MODEL_ID_LIGHT_HSL_SRV);
    lhsl_srv = (qcc74x_ble_mesh_light_hsl_srv_t*)lhsl_m->user_data;
...
static void gen_dev_uuid(void)
{
//device uuid: 000a0000-1111-2222-3333-mac address(6 bytes)

	bt_addr_le_t adv_addr;
	bt_get_local_public_address(&adv_addr);
	u8_t uuid[16] = {0x00,0x0a,0x00,0x00,0x11,0x11,0x22,0x22,0x33,0x33,
	                        adv_addr.a.val[5],
	                        adv_addr.a.val[4],
	                        adv_addr.a.val[3],
	                        adv_addr.a.val[2],
...
#if defined(CONFIG_BT_MESH_MODEL)
#if defined(CONFIG_BT_MESH_MODEL_GEN_CLI)
void ble_mesh_generic_onoff_client_model_cb(qcc74x_ble_mesh_generic_client_cb_event_t event,
        qcc74x_ble_mesh_generic_client_cb_param_t *param)
{
    uint32_t opcode = param->params->opcode;
...
BLEMESH_CLI(gen_oo_cli)
{
    ...
    qcc74x_ble_mesh_generic_client_set_state_t gen_client_set;
    qcc74x_ble_mesh_generic_client_get_state_t gen_client_get;
    qcc74x_ble_mesh_client_common_param_t onoff_common = {
        .msg_timeout = 0,
        .ctx.send_ttl = 7,
        .model = NULL,
    };
	...
	for(int i = 0; i < sizeof(sig_models)/sizeof(struct bt_mesh_model); ++i){
		if(sig_models[i].id == QCC74x_BLE_MESH_MODEL_ID_GEN_ONOFF_CLI){
    ...
    if (strcmp(argv[1], "get") == 0) {
        err = qcc74x_ble_mesh_generic_client_get_state(&onoff_common, &gen_client_get);
...
#if defined(CONFIG_BT_MESH_TEST)
        if(onoff_common.opcode == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET
            && BT_MESH_ADDR_IS_GROUP(onoff_common.ctx.addr)){
            nodelist_check_clear();
        }
#endif /* CONFIG_BT_MESH_TEST */
        err = qcc74x_ble_mesh_generic_client_set_state(&onoff_common, &gen_client_set);
    } else if (strcmp(argv[1], "reg") == 0) {
        err = qcc74x_ble_mesh_register_generic_client_callback(ble_mesh_generic_onoff_client_model_cb);
        if (err == QCC74x_OK) {
...
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_CLI)
void ble_mesh_light_client_model_cb(qcc74x_ble_mesh_light_client_cb_event_t event,
        qcc74x_ble_mesh_light_client_cb_param_t *param)
{
	uint32_t opcode = param->params->opcode;
    ...
    switch (event) {
    case QCC74x_BLE_MESH_LIGHT_CLIENT_GET_STATE_EVT: {
        switch (opcode) {
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_GET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_GET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_GET:
            if (param->error_code == QCC74x_OK) {
    ...
    case QCC74x_BLE_MESH_LIGHT_CLIENT_SET_STATE_EVT: {
        switch (opcode) {
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET_UNACK:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_SET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_SET_UNACK:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SET:
            if (param->error_code == QCC74x_OK) {
            ...
            break;
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_SET_UNACK:
            if (param->error_code == QCC74x_OK) {
    ...
    case QCC74x_BLE_MESH_LIGHT_CLIENT_PUBLISH_EVT: {
		switch (opcode) {
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_GET:
	        if (param->error_code == QCC74x_OK) {
    ...
    case QCC74x_BLE_MESH_LIGHT_CLIENT_TIMEOUT_EVT:{
		switch (opcode) {
        case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_GET:
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET:
		case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET_UNACK:
    ...
    case QCC74x_BLE_MESH_LIGHT_CLIENT_EVT_MAX:{
...
BLEMESH_CLI(light_lgn_cli)
{
    ...
    qcc74x_ble_mesh_light_client_set_state_t light_client_set;
    qcc74x_ble_mesh_light_client_get_state_t light_client_get;
    qcc74x_ble_mesh_client_common_param_t lgn_common = {
        .msg_timeout = 0,
        .ctx.send_ttl = 7,
        .model = NULL,
    };
	...
	/*Get client model*/
	for(int i = 0; i < sizeof(sig_models)/sizeof(struct bt_mesh_model); ++i){
		if(sig_models[i].id == QCC74x_BLE_MESH_MODEL_ID_LIGHT_LIGHTNESS_CLI){
    ...
    if (strcmp(argv[1], "get") == 0) {
        err = qcc74x_ble_mesh_light_client_get_state(&lgn_common, &light_client_get);
    } else if (strcmp(argv[1], "set") == 0) {
        err = qcc74x_ble_mesh_light_client_set_state(&lgn_common, &light_client_set);
    } else if (strcmp(argv[1], "reg") == 0) {
        err = qcc74x_ble_mesh_register_light_client_callback(ble_mesh_light_client_model_cb);
        if (err == QCC74x_OK) {
...
BLEMESH_CLI(light_ctl_cli)
{
	...
	qcc74x_ble_mesh_light_client_set_state_t light_client_set;
	qcc74x_ble_mesh_light_client_get_state_t light_client_get;
	qcc74x_ble_mesh_client_common_param_t ctl_common = {
		.msg_timeout = 0,
		.ctx.send_ttl = 7,
		.model = NULL,
	};
	...
	/*Get client model*/
	for(int i = 0; i < sizeof(sig_models)/sizeof(struct bt_mesh_model); ++i){
		if(sig_models[i].id == QCC74x_BLE_MESH_MODEL_ID_LIGHT_CTL_CLI){
	...
	if (strcmp(argv[1], "get") == 0) {
		err = qcc74x_ble_mesh_light_client_get_state(&ctl_common, &light_client_get);
	} else if (strcmp(argv[1], "set") == 0) {
		err = qcc74x_ble_mesh_light_client_set_state(&ctl_common, &light_client_set);
	} else if (strcmp(argv[1], "reg") == 0) {
		err = qcc74x_ble_mesh_register_light_client_callback(ble_mesh_light_client_model_cb);
		if (err == QCC74x_OK) {
			vOutputString("Light lightness client:Reg,OK\n");
...
BLEMESH_CLI(light_hsl_cli)
{
	...
	qcc74x_ble_mesh_light_client_set_state_t light_client_set;
	qcc74x_ble_mesh_light_client_get_state_t light_client_get;
	qcc74x_ble_mesh_client_common_param_t hsl_common = {
		.msg_timeout = 0,
		.ctx.send_ttl = 7,
		.model = NULL,
	};
	...
	/*Get client model*/
	for(int i = 0; i < sizeof(sig_models)/sizeof(struct bt_mesh_model); ++i){
		if(sig_models[i].id == QCC74x_BLE_MESH_MODEL_ID_LIGHT_HSL_CLI){
	...
	if (strcmp(argv[1], "get") == 0) {
		err = qcc74x_ble_mesh_light_client_get_state(&hsl_common, &light_client_get);
	} else if (strcmp(argv[1], "set") == 0) {
		err = qcc74x_ble_mesh_light_client_set_state(&hsl_common, &light_client_set);
	} else if (strcmp(argv[1], "reg") == 0) {
		err = qcc74x_ble_mesh_register_light_client_callback(ble_mesh_light_client_model_cb);
		if (err == QCC74x_OK) {
			vOutputString("Light lightness client:Reg,OK\n");
...
BLEMESH_CLI(vendor_cli)
{
    ...
    BT_MESH_MODEL_BUF_DEFINE(msg, BT_MESH_MODEL_OP_3(0x0000, QCC74x_COMP_ID), 40);
    ...
    bt_mesh_model_msg_init(&msg, BT_MESH_MODEL_OP_3(id, QCC74x_COMP_ID));
    ...
    model_t = bt_mesh_model_find_vnd(elements, QCC74x_COMP_ID, BT_MESH_VND_MODEL_ID_DATA_CLI);
    if(model_t == NULL){
...
/* Added by qcc74x for health client fault state*/
BLEMESH_CLI(clhm_fault)
{
	int err = 0;
...
/* Added by qcc74x for health client period state*/
BLEMESH_CLI(clhm_period)
{
...
/* Added by qcc74x for health client attention timer state*/
BLEMESH_CLI(clhm_ats)
{
...
BLEMESH_CLI(sync_start)
{
	return qcc74xsync_blemesh_start();
}

BLEMESH_CLI(sync_stop)
{
	return qcc74xsync_blemesh_stop();
}
#endif
