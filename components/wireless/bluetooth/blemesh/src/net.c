...
#endif
#if !defined(QCC74x_BLE_MESH_PATCH_NET_DECODE)
...
/* Added by qcc74x to clear msg cache indicated by addr */
...
#if defined(QCC74x_BLE_MESH_PATCH_NET_REVOKE_KEYS)
...
bool bt_mesh_kr_update(struct bt_mesh_subnet *sub, u8_t new_kr, bool new_key)
{
	...
	if (sub->kr_flag) {
		 ...
		 */
			__attribute__((fallthrough));/* Fix compile error by qcc74x  */
