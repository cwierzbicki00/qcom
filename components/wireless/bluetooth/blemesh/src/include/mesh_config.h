...
#define CONFIG_BT_DEVICE_NAME "qcc74x_mesh"
#endif
...
#define QCC74x_COMP_ID                           0x000A
#define QCC74x_PRODUCT_ID                        0x0001

/********************************QCC74x_BLE patch to fix mesh bug**************************************/
#define QCC74x_BLE_MESH_PATCH_DEL_APPKEY
#define QCC74x_BLE_MESH_PATCH_NET_REVOKE_KEYS
#define QCC74x_BLE_MESH_PATCH_NET_DECODE
#define QCC74x_BLE_MESH_PATCH_IGNORE_SECURE_BEACON
#define QCC74x_BLE_MESH_PATCH_MOD_PUB_VA_SET
#define QCC74x_BLE_MESH_PATCH_HEARTBEAT_SUB_GET
#define QCC74x_BLE_MESH_PATCH_HEARTBEAT_SUB_SET
#define QCC74x_BLE_MESH_PATCH_PROV_NODE_CFM_RECVED_BEFORE_DH
/* Fix mesh message can not be decrypt by received device,
 * casued by bt_mesh.seq is changed during encryption using appkey.
 */
#define QCC74x_BLE_MESH_FIX_MESH_ENCRYPT_ERR_DURING_ENCRYPT_USING_APPKEY
#endif
