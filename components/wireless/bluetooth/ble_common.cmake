# # PRIV_CONFIG_GEN_BLE is and should only be defined in qcc74x.mk in the 'blecontroller_*' component
...
# 
# CHIP_LIST := QCC74x_undef QCC74x_undef
...
# endif
if(("${CHIP}" STREQUAL "qcc74x_undef") OR ("${CHIP}" STREQUAL "qcc74x_undef"))
...
# 
# 
# ifeq ($(CONFIG_CHIP_NAME),QCC74x_undefL)
# CONFIG_BT := 0
# CONFIG_CIS := 0
...
# CONFIG_CTE := 0
# CONFIG_EM_SIZE ?= 16
if("${CHIP}" STREQUAL "qcc74x_undefl")
	set(CONFIG_BT 0)
	set(CONFIG_CIS 0)
...
# endif
	if("${PRIV_CONFIG_GEN_BLE}" STREQUAL "m0s1rp")
		set(CONFIG_QCC74x_undefL_A1 1)
		set(CONFIG_BUILD_BLE_ROM_CODE 0)
		set(CONFIG_BLE_PDS 1)
		set(CONFIG_BT_CONN 1)
...
# 
# ifeq ($(CONFIG_CHIP_NAME),QCC74x_undef)
# CFLAGS   += -DQCC74x_undef
# CFLAGS   += -DCONFIG_SET_TX_PWR
# endif
if("${CHIP}" STREQUAL "qcc74x_undef")
#	sdk_add_compile_definitions(-DQCC74x_undef)
...
# 
# ifeq ($(CONFIG_CHIP_NAME),QCC74x_undefP)
# CFLAGS   += -DQCC74x_undefP
# CONFIG_BT_RESET=0
# endif
if("${CHIP}" STREQUAL "qcc74x_undefp")
#	sdk_add_compile_definitions(-DQCC74x_undefP)
...
# 
# ifeq ($(CONFIG_CHIP_NAME),QCC74x_undefL)
# CFLAGS   += -DQCC74x_undefL
# endif
if("${CHIP}" STREQUAL "qcc74x_undefl")
#	sdk_add_compile_definitions(-DQCC74x_undefL)
endif()
# 
...
sdk_add_compile_definitions(-DQCC74x_BLE)
sdk_add_compile_definitions(-DCFG_BLE)
#
# CONFIG_QCC74x_undefL_A1?=0
sdk_ifndef(CONFIG_QCC74x_undefL_A1 0)
#
# CONFIG_BT_BREDR?=0
...
if(NOT CONFIG_BT_BREDR)
	...
	sdk_ifndef(CONFIG_BT_A2DP_SOURCE 0)
...
#
# ifeq ($(CONFIG_QCC74x_undefL_A1),1)
# CFLAGS += -DCFG_QCC74x_undefL_A1
# CONFIG_BLE_TX_BUFF_DATA = 2
# endif
#
if(CONFIG_QCC74x_undefL_A1)
	sdk_add_compile_definitions(-DCFG_QCC74x_undefL_A1)
	set(CONFIG_BLE_TX_BUFF_DATA 2)
endif()
# 
# ifeq ($(CONFIG_BT_TL),1)
...
# CFLAGS += -DCONFIG_QCC74x_SDK
# endif
# ifneq ($(CONFIG_IOT_SDK_DISABLE),1)
# CFLAGS   += -DCFG_IOT_SDK
# endif
sdk_add_compile_definitions(-DCONFIG_QCC74x_SDK)
...
if(CONFIG_BT_MFG)
	...
	set(CONFIG_CIS 0)
	set(CONFIG_BIS 0)
	sdk_ifndef(CONFIG_LE_PWR_CTRL 0)
endif()
# 
# CONFIG_BT ?= 1
# CONFIG_SCO_ESCO ?= 1
...
sdk_ifndef(CONFIG_BT_REMOTE_VERSION 0)
# 
# #Update le adv data and scan rsp data when LE adertising is active, sw need 4 adv buffer at least. 
# CONFIG_BLE_ACT_MAX ?= 7
...
sdk_ifndef(CONFIG_BT_TP_CLI 0)
sdk_ifndef(CONFIG_BLE_STACK_DBG_PRINT 1)
sdk_ifndef(CONFIG_BT_STACK_PTS 0)
sdk_ifndef(CONFIG_BT_MESH_PTS 0)
sdk_ifndef(CONFIG_BLE_TP_TEST 0)
...
# endif
sdk_add_compile_definitions_ifdef(CONFIG_EM_HEAP_DISABLE -DCFG_EM_HEAP_DISABLE)
# 
...
if(CONFIG_BT_MESH)
	...
	if("${CHIP}" STREQUAL "qcc74x_undef")
		sdk_add_compile_definitions(-DQCC74x_CRYPT_HARDWARE)
	elseif("${CHIP}" STREQUAL "qcc74x_undef")
		sdk_add_compile_definitions(-DQCC74x_CRYPT_HARDWARE)
	endif()
