#ifndef __QCC743_ROMDRIVER_E907_H__
#define __QCC743_ROMDRIVER_E907_H__
...
#define RomDriver_AON_Power_Off_LDO15_RF                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_Off_LDO15_RF])

#define RomDriver_AON_Power_Off_MBG                       \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_Off_MBG])

#define RomDriver_AON_Power_Off_SFReg                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_Off_SFReg])

#define RomDriver_AON_Power_Off_XTAL                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_Off_XTAL])

#define RomDriver_AON_Power_On_BG                         \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_On_BG])

#define RomDriver_AON_Power_On_LDO15_RF                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_On_LDO15_RF])

#define RomDriver_AON_Power_On_MBG                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_On_MBG])

#define RomDriver_AON_Power_On_SFReg                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_On_SFReg])

#define RomDriver_AON_Power_On_XTAL                       \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Power_On_XTAL])

#define RomDriver_AON_Set_Xtal_CapCode                    \
    ((QCC74x_Err_Type (*) (uint8_t capIn, uint8_t capOut))ROM_APITABLE[ROM_API_INDEX_AON_Set_Xtal_CapCode])

#define RomDriver_AON_Trim_DcdcDis                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Trim_DcdcDis])

#define RomDriver_AON_Trim_DcdcVoutSel                    \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Trim_DcdcVoutSel])

#define RomDriver_AON_Trim_DcdcVoutTrim                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Trim_DcdcVoutTrim])

#define RomDriver_AON_Trim_Ldo11socVoutTrim               \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Trim_Ldo11socVoutTrim])

#define RomDriver_AON_Trim_Usb20RcalCode                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_AON_Trim_Usb20RcalCode])
...
#define RomDriver_CPU_MTimer_Delay_MS                     \
    ((QCC74x_Err_Type (*) (uint32_t cnt))ROM_APITABLE[ROM_API_INDEX_CPU_MTimer_Delay_MS])

#define RomDriver_CPU_MTimer_Delay_US                     \
    ((QCC74x_Err_Type (*) (uint32_t cnt))ROM_APITABLE[ROM_API_INDEX_CPU_MTimer_Delay_US])

#define RomDriver_CPU_Reset_MTimer                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_CPU_Reset_MTimer])

#define RomDriver_CPU_Set_MTimer_CLK                      \
    ((QCC74x_Err_Type (*) (uint8_t enable, QCC74x_MTimer_Source_Clock_Type mTimerSourceClockType, uint16_t div))ROM_APITABLE[ROM_API_INDEX_CPU_Set_MTimer_CLK])

#define RomDriver_CPU_Set_MTimer_RST                      \
    ((QCC74x_Err_Type (*) (uint8_t rstEn))ROM_APITABLE[ROM_API_INDEX_CPU_Set_MTimer_RST])
...
#define RomDriver_Clock_Peripheral_Clock_Get              \
    ((uint32_t (*) (QCC74x_Peripheral_Type type))ROM_APITABLE[ROM_API_INDEX_Clock_Peripheral_Clock_Get])

#define RomDriver_Clock_System_Clock_Get                  \
    ((uint32_t (*) (QCC74x_System_Clock_Type type))ROM_APITABLE[ROM_API_INDEX_Clock_System_Clock_Get])
...
#define RomDriver_EF_Ctrl_Crc_Result                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Crc_Result])

#define RomDriver_EF_Ctrl_Get_Customer_PIDVID             \
    ((QCC74x_Err_Type (*) (uint16_t pid[1], uint16_t vid[1]))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Get_Customer_PIDVID])

#define RomDriver_EF_Ctrl_Read_Chip_ID                    \
    ((QCC74x_Err_Type (*) (uint8_t chipID[8]))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Read_Chip_ID])

#define RomDriver_EF_Ctrl_Read_MAC_Address                \
    ((QCC74x_Err_Type (*) (uint8_t mac[6]))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Read_MAC_Address])

#define RomDriver_EF_Ctrl_Read_MAC_Address_Raw            \
    ((QCC74x_Err_Type (*) (uint8_t mac[7]))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Read_MAC_Address_Raw])

#define RomDriver_EF_Ctrl_AutoLoad_Done                   \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_AutoLoad_Done])

#define RomDriver_EF_Ctrl_Busy                            \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Busy])

#define RomDriver_EF_Ctrl_Crc_Is_Busy                     \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_EF_Ctrl_Crc_Is_Busy])
...
#define RomDriver_GLB_AHB_MCU_Software_Reset              \
    ((QCC74x_Err_Type (*) (uint8_t swrst))ROM_APITABLE[ROM_API_INDEX_GLB_AHB_MCU_Software_Reset])

#define RomDriver_GLB_AUPLL_Ref_Clk_Sel                   \
    ((QCC74x_Err_Type (*) (uint8_t refClk))ROM_APITABLE[ROM_API_INDEX_GLB_AUPLL_Ref_Clk_Sel])

#define RomDriver_GLB_BMX_TO_Init                         \
    ((QCC74x_Err_Type (*) (BMX_TO_Cfg_Type *BmxCfg))ROM_APITABLE[ROM_API_INDEX_GLB_BMX_TO_Init])

#define RomDriver_GLB_Clr_BMX_TO_Status                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Clr_BMX_TO_Status])

#define RomDriver_GLB_Clr_EMI_Reset_Gate                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Clr_EMI_Reset_Gate])

#define RomDriver_GLB_Clr_Reset_Reason                    \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Clr_Reset_Reason])

#define RomDriver_GLB_Config_SDIO_Host_Interrupt_CPU      \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Config_SDIO_Host_Interrupt_CPU])

#define RomDriver_GLB_Config_SDIO_Host_Reset_SDU          \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Config_SDIO_Host_Reset_SDU])

#define RomDriver_GLB_Config_SDIO_Host_Reset_System       \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Config_SDIO_Host_Reset_System])

#define RomDriver_GLB_Get_Auto_Calc_Xtal_Type             \
    ((QCC74x_Err_Type (*) (uint8_t *calcXtalType))ROM_APITABLE[ROM_API_INDEX_GLB_Get_Auto_Calc_Xtal_Type])

#define RomDriver_GLB_Get_MCU_System_CLK_Div              \
    ((QCC74x_Err_Type (*) (uint8_t *mcuClkDiv, uint8_t *mcuPBclkDiv))ROM_APITABLE[ROM_API_INDEX_GLB_Get_MCU_System_CLK_Div])

#define RomDriver_GLB_Get_Reset_Reason                    \
    ((QCC74x_Err_Type (*) (GLB_RESET_RECORD_Type *reason))ROM_APITABLE[ROM_API_INDEX_GLB_Get_Reset_Reason])

#define RomDriver_GLB_IR_RX_GPIO_Sel                      \
    ((QCC74x_Err_Type (*) (uint8_t gpio))ROM_APITABLE[ROM_API_INDEX_GLB_IR_RX_GPIO_Sel])

#define RomDriver_GLB_Invert_ETH_REF_O_CLK                \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Invert_ETH_REF_O_CLK])

#define RomDriver_GLB_Invert_ETH_RX_CLK                   \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Invert_ETH_RX_CLK])

#define RomDriver_GLB_Invert_ETH_TX_CLK                   \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Invert_ETH_TX_CLK])

#define RomDriver_GLB_MCU_SW_System_Reset                 \
    ((QCC74x_Err_Type (*) (uint8_t sysPart))ROM_APITABLE[ROM_API_INDEX_GLB_MCU_SW_System_Reset])

#define RomDriver_GLB_PER_Clock_Gate                      \
    ((QCC74x_Err_Type (*) (uint64_t ips))ROM_APITABLE[ROM_API_INDEX_GLB_PER_Clock_Gate])

#define RomDriver_GLB_PER_Clock_UnGate                    \
    ((QCC74x_Err_Type (*) (uint64_t ips))ROM_APITABLE[ROM_API_INDEX_GLB_PER_Clock_UnGate])

#define RomDriver_GLB_PLL_CGEN_Clock_Gate                 \
    ((QCC74x_Err_Type (*) (uint8_t clk))ROM_APITABLE[ROM_API_INDEX_GLB_PLL_CGEN_Clock_Gate])

#define RomDriver_GLB_PLL_CGEN_Clock_UnGate               \
    ((QCC74x_Err_Type (*) (uint8_t clk))ROM_APITABLE[ROM_API_INDEX_GLB_PLL_CGEN_Clock_UnGate])

#define RomDriver_GLB_Platform_Wakeup_PDS_Enable          \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Platform_Wakeup_PDS_Enable])

#define RomDriver_GLB_Power_Off_AUPLL                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Power_Off_AUPLL])

#define RomDriver_GLB_Power_Off_WIFIPLL                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Power_Off_WIFIPLL])

#define RomDriver_GLB_Power_On_AUPLL                      \
    ((QCC74x_Err_Type (*) (const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable))ROM_APITABLE[ROM_API_INDEX_GLB_Power_On_AUPLL])

#define RomDriver_GLB_Power_On_WIFIPLL                    \
    ((QCC74x_Err_Type (*) (const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable))ROM_APITABLE[ROM_API_INDEX_GLB_Power_On_WIFIPLL])

#define RomDriver_GLB_Power_On_XTAL_And_PLL_CLK           \
    ((QCC74x_Err_Type (*) (uint8_t xtalType, uint8_t pllType))ROM_APITABLE[ROM_API_INDEX_GLB_Power_On_XTAL_And_PLL_CLK])

#define RomDriver_GLB_SPI_Sig_Swap_Set                    \
    ((QCC74x_Err_Type (*) (uint8_t group, uint8_t swap))ROM_APITABLE[ROM_API_INDEX_GLB_SPI_Sig_Swap_Set])

#define RomDriver_GLB_SW_CPU_Reset                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_SW_CPU_Reset])

#define RomDriver_GLB_SW_POR_Reset                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_SW_POR_Reset])

#define RomDriver_GLB_SW_System_Reset                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_SW_System_Reset])

#define RomDriver_GLB_Sel_MCU_TMR_GPIO_Clock              \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_Sel_MCU_TMR_GPIO_Clock])

#define RomDriver_GLB_Set_ADC_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_ADC_CLK])

#define RomDriver_GLB_Set_Audio_ADC_CLK                   \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Audio_ADC_CLK])

#define RomDriver_GLB_Set_Audio_AUTO_CLK                  \
    ((QCC74x_Err_Type (*) (uint8_t divEn))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Audio_AUTO_CLK])

#define RomDriver_GLB_Set_Audio_SOLO_CLK                  \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Audio_SOLO_CLK])

#define RomDriver_GLB_Set_Auto_Calc_Xtal_Type             \
    ((QCC74x_Err_Type (*) (uint8_t calcXtalType))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Auto_Calc_Xtal_Type])

#define RomDriver_GLB_Set_CAM_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_CAM_CLK])

#define RomDriver_GLB_Set_CPU_Reset_Address               \
    ((QCC74x_Err_Type (*) (uint8_t coreID, uint32_t addr))ROM_APITABLE[ROM_API_INDEX_GLB_Set_CPU_Reset_Address])

#define RomDriver_GLB_Set_Chip_Clock_Out_Sel              \
    ((QCC74x_Err_Type (*) (GLB_CHIP_CLK_OUT_CFG_Type *cfg))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Chip_Clock_Out_Sel])

#define RomDriver_GLB_Set_DBI_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_DBI_CLK])

#define RomDriver_GLB_Set_DIG_32K_CLK                     \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t compensationEn, uint16_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_DIG_32K_CLK])

#define RomDriver_GLB_Set_DIG_512K_CLK                    \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t compensationEn, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_DIG_512K_CLK])

#define RomDriver_GLB_Set_DIG_CLK_Sel                     \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_DIG_CLK_Sel])

#define RomDriver_GLB_Set_DMA_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clk))ROM_APITABLE[ROM_API_INDEX_GLB_Set_DMA_CLK])

#define RomDriver_GLB_Set_EM_Sel                          \
    ((QCC74x_Err_Type (*) (uint8_t emType))ROM_APITABLE[ROM_API_INDEX_GLB_Set_EM_Sel])

#define RomDriver_GLB_Set_ETH_REF_O_CLK_Sel               \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_ETH_REF_O_CLK_Sel])

#define RomDriver_GLB_Set_I2C_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_I2C_CLK])

#define RomDriver_GLB_Set_I2S_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t refClkEn, uint8_t refClkDiv, uint8_t inRef, uint8_t outRef))ROM_APITABLE[ROM_API_INDEX_GLB_Set_I2S_CLK])

#define RomDriver_GLB_Set_IR_CLK                          \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_IR_CLK])

#define RomDriver_GLB_Set_ISP_Muxpll_80M_Sel              \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_ISP_Muxpll_80M_Sel])

#define RomDriver_GLB_Set_MCU_Muxpll_160M_Sel             \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_MCU_Muxpll_160M_Sel])

#define RomDriver_GLB_Set_MCU_Muxpll_80M_Sel              \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_MCU_Muxpll_80M_Sel])

#define RomDriver_GLB_Set_MCU_SPI_0_ACT_MOD_Sel           \
    ((QCC74x_Err_Type (*) (uint8_t mod))ROM_APITABLE[ROM_API_INDEX_GLB_Set_MCU_SPI_0_ACT_MOD_Sel])

#define RomDriver_GLB_Set_MCU_System_CLK                  \
    ((QCC74x_Err_Type (*) (uint8_t clkFreq))ROM_APITABLE[ROM_API_INDEX_GLB_Set_MCU_System_CLK])

#define RomDriver_GLB_Set_MCU_System_CLK_Div              \
    ((QCC74x_Err_Type (*) (uint8_t mcuClkDiv, uint8_t mcuPBclkDiv))ROM_APITABLE[ROM_API_INDEX_GLB_Set_MCU_System_CLK_Div])

#define RomDriver_GLB_Set_PDM_IO_Sel                      \
    ((QCC74x_Err_Type (*) (uint8_t ioSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_PDM_IO_Sel])

#define RomDriver_GLB_Set_PKA_CLK_Sel                     \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_PKA_CLK_Sel])

#define RomDriver_GLB_Set_PSRAMB_CLK_Sel                  \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_PSRAMB_CLK_Sel])

#define RomDriver_GLB_Set_PWM1_IO_Sel                     \
    ((QCC74x_Err_Type (*) (uint8_t ioSel))ROM_APITABLE[ROM_API_INDEX_GLB_Set_PWM1_IO_Sel])

#define RomDriver_GLB_Set_Peripheral_DMA_CN               \
    ((QCC74x_Err_Type (*) (uint8_t peri, uint8_t cn))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Peripheral_DMA_CN])

#define RomDriver_GLB_Set_SDH_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SDH_CLK])

#define RomDriver_GLB_Set_SF_CLK                          \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SF_CLK])

#define RomDriver_GLB_Set_SFlash2_IO_PARM                 \
    ((QCC74x_Err_Type (*) (uint8_t swapIo3Io0))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SFlash2_IO_PARM])

#define RomDriver_GLB_Set_SFlash_IO_PARM                  \
    ((QCC74x_Err_Type (*) (uint8_t selEmbedded, uint8_t swapIo3Io0, uint8_t swapIo2Cs))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SFlash_IO_PARM])

#define RomDriver_GLB_Set_SPI_CLK                         \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SPI_CLK])

#define RomDriver_GLB_Set_SRAM_PARM                       \
    ((QCC74x_Err_Type (*) (uint32_t value))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SRAM_PARM])

#define RomDriver_GLB_Set_SRAM_RET                        \
    ((QCC74x_Err_Type (*) (uint32_t value))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SRAM_RET])

#define RomDriver_GLB_Set_SRAM_SLP                        \
    ((QCC74x_Err_Type (*) (uint32_t value))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SRAM_SLP])

#define RomDriver_GLB_Set_SSC_CLK_From_WIFIPLL            \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Set_SSC_CLK_From_WIFIPLL])

#define RomDriver_GLB_Set_Slave_Grp_0_CLK                 \
    ((QCC74x_Err_Type (*) (uint8_t slave, uint8_t enable, GLB_SLAVE_GRP_0_CLK_SEL_Type clkSel, uint32_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_Slave_Grp_0_CLK])

#define RomDriver_GLB_Set_UART_CLK                        \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t clkSel, uint8_t div))ROM_APITABLE[ROM_API_INDEX_GLB_Set_UART_CLK])

#define RomDriver_GLB_Set_USB_CLK_From_WIFIPLL            \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_GLB_Set_USB_CLK_From_WIFIPLL])

#define RomDriver_GLB_Swap_MCU_SPI_0_MOSI_With_MISO       \
    ((QCC74x_Err_Type (*) (QCC74x_Fun_Type newState))ROM_APITABLE[ROM_API_INDEX_GLB_Swap_MCU_SPI_0_MOSI_With_MISO])

#define RomDriver_GLB_Trim_Ldo18ioBypass                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Trim_Ldo18ioBypass])

#define RomDriver_GLB_Trim_Ldo18ioVoutSel                 \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Trim_Ldo18ioVoutSel])

#define RomDriver_GLB_Trim_Ldo18ioVoutTrim                \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_Trim_Ldo18ioVoutTrim])

#define RomDriver_GLB_UART_Fun_Sel                        \
    ((QCC74x_Err_Type (*) (uint8_t sig, uint8_t fun))ROM_APITABLE[ROM_API_INDEX_GLB_UART_Fun_Sel])

#define RomDriver_GLB_UART_Sig_Swap_Set                   \
    ((QCC74x_Err_Type (*) (uint8_t group, uint8_t swap))ROM_APITABLE[ROM_API_INDEX_GLB_UART_Sig_Swap_Set])

#define RomDriver_GLB_WIFIPLL_Ref_Clk_Sel                 \
    ((QCC74x_Err_Type (*) (uint8_t refClk))ROM_APITABLE[ROM_API_INDEX_GLB_WIFIPLL_Ref_Clk_Sel])
...
#define RomDriver_GLB_Clr_GPIO_IntStatus                  \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_Clr_GPIO_IntStatus])

#define RomDriver_GLB_Embedded_Flash_Pad_Enable           \
    ((QCC74x_Err_Type (*) (uint8_t swapIo2Cs))ROM_APITABLE[ROM_API_INDEX_GLB_Embedded_Flash_Pad_Enable])

#define RomDriver_GLB_GPIO_Clr                            \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Clr])

#define RomDriver_GLB_GPIO_Fifo_Clear                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_Clear])

#define RomDriver_GLB_GPIO_Fifo_Init                      \
    ((QCC74x_Err_Type (*) (GLB_GPIO_FIFO_CFG_Type *cfg))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_Init])

#define RomDriver_GLB_GPIO_Fifo_IntClear                  \
    ((QCC74x_Err_Type (*) (uint8_t intType))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_IntClear])

#define RomDriver_GLB_GPIO_Fifo_IntMask                   \
    ((QCC74x_Err_Type (*) (uint8_t intType, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_IntMask])

#define RomDriver_GLB_GPIO_Fifo_Push                      \
    ((QCC74x_Err_Type (*) (uint16_t *data, uint16_t len))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_Push])

#define RomDriver_GLB_GPIO_Func_Init                      \
    ((QCC74x_Err_Type (*) (uint8_t gpioFun, uint8_t *pinList, uint8_t cnt))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Func_Init])

#define RomDriver_GLB_GPIO_Init                           \
    ((QCC74x_Err_Type (*) (GLB_GPIO_Cfg_Type *cfg))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Init])

#define RomDriver_GLB_GPIO_Input_Disable                  \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Input_Disable])

#define RomDriver_GLB_GPIO_Input_Enable                   \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Input_Enable])

#define RomDriver_GLB_GPIO_IntMask                        \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_IntMask])

#define RomDriver_GLB_GPIO_Int_Init                       \
    ((QCC74x_Err_Type (*) (GLB_GPIO_INT_Cfg_Type *intCfg))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Int_Init])

#define RomDriver_GLB_GPIO_Output_Disable                 \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Output_Disable])

#define RomDriver_GLB_GPIO_Output_Enable                  \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Output_Enable])

#define RomDriver_GLB_GPIO_Set                            \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Set])

#define RomDriver_GLB_GPIO_Set_HZ                         \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Set_HZ])

#define RomDriver_GLB_GPIO_Write                          \
    ((QCC74x_Err_Type (*) (uint8_t gpioPin, uint32_t val))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Write])

#define RomDriver_GLB_GPIO_Fifo_Disable                   \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_Disable])

#define RomDriver_GLB_GPIO_Fifo_Enable                    \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_Enable])

#define RomDriver_GLB_GPIO_Fifo_GetIntStatus              \
    ((QCC74x_Sts_Type (*) (uint8_t intType))ROM_APITABLE[ROM_API_INDEX_GLB_GPIO_Fifo_GetIntStatus])

#define RomDriver_GLB_Get_GPIO_IntStatus                  \
    ((QCC74x_Sts_Type (*) (uint8_t gpioPin))ROM_APITABLE[ROM_API_INDEX_GLB_Get_GPIO_IntStatus])
...
#define RomDriver_HBN_32K_Sel                             \
    ((QCC74x_Err_Type (*) (uint8_t clkType))ROM_APITABLE[ROM_API_INDEX_HBN_32K_Sel])

#define RomDriver_HBN_Aon_Pad_Cfg                         \
    ((QCC74x_Err_Type (*) (uint8_t aonPadHwCtrlEn, uint8_t aonGpio, HBN_AON_PAD_CFG_Type *aonPadCfg))ROM_APITABLE[ROM_API_INDEX_HBN_Aon_Pad_Cfg])

#define RomDriver_HBN_Aon_Pad_Cfg_Set                     \
    ((QCC74x_Err_Type (*) (uint8_t aonPadHwCtrlEn, uint8_t aonGpio))ROM_APITABLE[ROM_API_INDEX_HBN_Aon_Pad_Cfg_Set])

#define RomDriver_HBN_Aon_Pad_Ctrl                        \
    ((QCC74x_Err_Type (*) (uint32_t aonPadCtl1, uint32_t aonPadCtl2))ROM_APITABLE[ROM_API_INDEX_HBN_Aon_Pad_Ctrl])

#define RomDriver_HBN_Aon_Pad_WakeUpCfg                   \
    ((QCC74x_Err_Type (*) (QCC74x_Fun_Type puPdEn, uint8_t trigMode, uint32_t maskVal, QCC74x_Fun_Type dlyEn, uint8_t dlySec))ROM_APITABLE[ROM_API_INDEX_HBN_Aon_Pad_WakeUpCfg])

#define RomDriver_HBN_Clear_Gpio_Keep                     \
    ((QCC74x_Err_Type (*) (uint8_t gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Clear_Gpio_Keep])

#define RomDriver_HBN_Clear_IRQ                           \
    ((QCC74x_Err_Type (*) (uint8_t irqType))ROM_APITABLE[ROM_API_INDEX_HBN_Clear_IRQ])

#define RomDriver_HBN_Clear_PDS_Gpio_Keep                 \
    ((QCC74x_Err_Type (*) (uint8_t gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Clear_PDS_Gpio_Keep])

#define RomDriver_HBN_Clear_RTC_Counter                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Clear_RTC_Counter])

#define RomDriver_HBN_Clear_RTC_INT                       \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Clear_RTC_INT])

#define RomDriver_HBN_Disable_AComp0_IRQ                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Disable_AComp0_IRQ])

#define RomDriver_HBN_Disable_AComp1_IRQ                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Disable_AComp1_IRQ])

#define RomDriver_HBN_Disable_BOD_IRQ                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Disable_BOD_IRQ])

#define RomDriver_HBN_Enable_AComp0_IRQ                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Enable_AComp0_IRQ])

#define RomDriver_HBN_Enable_AComp1_IRQ                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Enable_AComp1_IRQ])

#define RomDriver_HBN_Enable_BOD_IRQ                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Enable_BOD_IRQ])

#define RomDriver_HBN_Enable_RTC_Counter                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Enable_RTC_Counter])

#define RomDriver_HBN_GPIO_INT_Disable                    \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_GPIO_INT_Disable])

#define RomDriver_HBN_GPIO_INT_Enable                     \
    ((QCC74x_Err_Type (*) (uint8_t gpioIntTrigType))ROM_APITABLE[ROM_API_INDEX_HBN_GPIO_INT_Enable])

#define RomDriver_HBN_Get_Flash_Power_Delay               \
    ((QCC74x_Err_Type (*) (uint8_t *flashPwrDly))ROM_APITABLE[ROM_API_INDEX_HBN_Get_Flash_Power_Delay])

#define RomDriver_HBN_Get_Gpio_Keep                       \
    ((QCC74x_Err_Type (*) (uint8_t *gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Get_Gpio_Keep])

#define RomDriver_HBN_Get_Ldo18io_Power_Delay_Config      \
    ((QCC74x_Err_Type (*) (uint16_t *pwrOffDly, uint16_t *pwrOnDly))ROM_APITABLE[ROM_API_INDEX_HBN_Get_Ldo18io_Power_Delay_Config])

#define RomDriver_HBN_Get_PDS_Gpio_Keep                   \
    ((QCC74x_Err_Type (*) (uint8_t *gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Get_PDS_Gpio_Keep])

#define RomDriver_HBN_Get_RTC_Timer_Val                   \
    ((QCC74x_Err_Type (*) (uint32_t *valLow, uint32_t *valHigh))ROM_APITABLE[ROM_API_INDEX_HBN_Get_RTC_Timer_Val])

#define RomDriver_HBN_Get_Xtal_Type                       \
    ((QCC74x_Err_Type (*) (uint8_t *xtalType))ROM_APITABLE[ROM_API_INDEX_HBN_Get_Xtal_Type])

#define RomDriver_HBN_Hw_Pu_Pd_Cfg                        \
    ((QCC74x_Err_Type (*) (uint8_t enable))ROM_APITABLE[ROM_API_INDEX_HBN_Hw_Pu_Pd_Cfg])

#define RomDriver_HBN_Keep_On_RC32K                       \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Keep_On_RC32K])

#define RomDriver_HBN_PIR_Disable                         \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_PIR_Disable])

#define RomDriver_HBN_PIR_Enable                          \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_PIR_Enable])

#define RomDriver_HBN_PIR_HPF_Sel                         \
    ((QCC74x_Err_Type (*) (uint8_t hpf))ROM_APITABLE[ROM_API_INDEX_HBN_PIR_HPF_Sel])

#define RomDriver_HBN_PIR_INT_Config                      \
    ((QCC74x_Err_Type (*) (HBN_PIR_INT_CFG_Type *pirIntCfg))ROM_APITABLE[ROM_API_INDEX_HBN_PIR_INT_Config])

#define RomDriver_HBN_PIR_LPF_Sel                         \
    ((QCC74x_Err_Type (*) (uint8_t lpf))ROM_APITABLE[ROM_API_INDEX_HBN_PIR_LPF_Sel])

#define RomDriver_HBN_Pin_WakeUp_Mask                     \
    ((QCC74x_Err_Type (*) (uint8_t maskVal))ROM_APITABLE[ROM_API_INDEX_HBN_Pin_WakeUp_Mask])

#define RomDriver_HBN_Power_Off_RC32K                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Power_Off_RC32K])

#define RomDriver_HBN_Power_Off_Xtal_32K                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Power_Off_Xtal_32K])

#define RomDriver_HBN_Power_On_Xtal_32K                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Power_On_Xtal_32K])

#define RomDriver_HBN_Reset                               \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Reset])

#define RomDriver_HBN_Set_BOD_Cfg                         \
    ((QCC74x_Err_Type (*) (HBN_BOD_CFG_Type *cfg))ROM_APITABLE[ROM_API_INDEX_HBN_Set_BOD_Cfg])

#define RomDriver_HBN_Set_BOD_Config                      \
    ((QCC74x_Err_Type (*) (uint8_t enable, uint8_t threshold, uint8_t mode))ROM_APITABLE[ROM_API_INDEX_HBN_Set_BOD_Config])

#define RomDriver_HBN_Set_Core_Reboot_Config              \
    ((QCC74x_Err_Type (*) (uint8_t core, uint8_t hcfg))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Core_Reboot_Config])

#define RomDriver_HBN_Set_Flash_Power_Delay               \
    ((QCC74x_Err_Type (*) (uint8_t flashPwrDly))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Flash_Power_Delay])

#define RomDriver_HBN_Set_GPADC_CLK_Sel                   \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_GPADC_CLK_Sel])

#define RomDriver_HBN_Set_Gpio_Keep                       \
    ((QCC74x_Err_Type (*) (uint8_t gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Gpio_Keep])

#define RomDriver_HBN_Set_HRAM_Ret                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Set_HRAM_Ret])

#define RomDriver_HBN_Set_HRAM_slp                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Set_HRAM_slp])

#define RomDriver_HBN_Set_Ldo11_All_Vout                  \
    ((QCC74x_Err_Type (*) (uint8_t ldoLevel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Ldo11_All_Vout])

#define RomDriver_HBN_Set_Ldo11_Aon_Vout                  \
    ((QCC74x_Err_Type (*) (uint8_t ldoLevel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Ldo11_Aon_Vout])

#define RomDriver_HBN_Set_Ldo11_Rt_Vout                   \
    ((QCC74x_Err_Type (*) (uint8_t ldoLevel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Ldo11_Rt_Vout])

#define RomDriver_HBN_Set_Ldo11_Soc_Vout                  \
    ((QCC74x_Err_Type (*) (uint8_t ldoLevel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Ldo11_Soc_Vout])

#define RomDriver_HBN_Set_Ldo18io_Power_Delay_Config      \
    ((QCC74x_Err_Type (*) (uint16_t pwrOffDly, uint16_t pwrOnDly))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Ldo18io_Power_Delay_Config])

#define RomDriver_HBN_Set_MCU_Root_CLK_Sel                \
    ((QCC74x_Err_Type (*) (uint8_t rootClk))ROM_APITABLE[ROM_API_INDEX_HBN_Set_MCU_Root_CLK_Sel])

#define RomDriver_HBN_Set_MCU_XCLK_Sel                    \
    ((QCC74x_Err_Type (*) (uint8_t xclk))ROM_APITABLE[ROM_API_INDEX_HBN_Set_MCU_XCLK_Sel])

#define RomDriver_HBN_Set_PDS_Gpio_Keep                   \
    ((QCC74x_Err_Type (*) (uint8_t gpioKeep))ROM_APITABLE[ROM_API_INDEX_HBN_Set_PDS_Gpio_Keep])

#define RomDriver_HBN_Set_PIR_Interval                    \
    ((QCC74x_Err_Type (*) (uint16_t interval))ROM_APITABLE[ROM_API_INDEX_HBN_Set_PIR_Interval])

#define RomDriver_HBN_Set_PIR_Threshold                   \
    ((QCC74x_Err_Type (*) (uint16_t threshold))ROM_APITABLE[ROM_API_INDEX_HBN_Set_PIR_Threshold])

#define RomDriver_HBN_Set_RTC_Timer                       \
    ((QCC74x_Err_Type (*) (uint8_t delay, uint32_t compValLow, uint32_t compValHigh, uint8_t compMode))ROM_APITABLE[ROM_API_INDEX_HBN_Set_RTC_Timer])

#define RomDriver_HBN_Set_Status_Flag                     \
    ((QCC74x_Err_Type (*) (uint32_t flag))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Status_Flag])

#define RomDriver_HBN_Set_UART_CLK_Sel                    \
    ((QCC74x_Err_Type (*) (uint8_t clkSel))ROM_APITABLE[ROM_API_INDEX_HBN_Set_UART_CLK_Sel])

#define RomDriver_HBN_Set_User_Boot_Config                \
    ((QCC74x_Err_Type (*) (uint8_t ubCfg))ROM_APITABLE[ROM_API_INDEX_HBN_Set_User_Boot_Config])

#define RomDriver_HBN_Set_Wakeup_Addr                     \
    ((QCC74x_Err_Type (*) (uint32_t addr))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Wakeup_Addr])

#define RomDriver_HBN_Set_Xtal_Type                       \
    ((QCC74x_Err_Type (*) (uint8_t xtalType))ROM_APITABLE[ROM_API_INDEX_HBN_Set_Xtal_Type])

#define RomDriver_HBN_Trim_Ldo33VoutTrim                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Trim_Ldo33VoutTrim])

#define RomDriver_HBN_Trim_RC32K                          \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Trim_RC32K])

#define RomDriver_HBN_Get_BOD_OUT_State                   \
    ((QCC74x_Sts_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_HBN_Get_BOD_OUT_State])

#define RomDriver_HBN_Get_INT_State                       \
    ((QCC74x_Sts_Type (*) (uint8_t irqType))ROM_APITABLE[ROM_API_INDEX_HBN_Get_INT_State])
...
#define RomDriver_L1C_DCache_Clean_All                    \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Clean_All])

#define RomDriver_L1C_DCache_Clean_By_Addr                \
    ((QCC74x_Err_Type (*) (uintptr_t addr, uint32_t len))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Clean_By_Addr])

#define RomDriver_L1C_DCache_Clean_Invalid_All            \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Clean_Invalid_All])

#define RomDriver_L1C_DCache_Clean_Invalid_By_Addr        \
    ((QCC74x_Err_Type (*) (uintptr_t addr, uint32_t len))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Clean_Invalid_By_Addr])

#define RomDriver_L1C_DCache_Disable                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Disable])

#define RomDriver_L1C_DCache_Enable                       \
    ((QCC74x_Err_Type (*) (uint8_t wayDsiable))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Enable])

#define RomDriver_L1C_DCache_Invalid_All                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Invalid_All])

#define RomDriver_L1C_DCache_Invalid_By_Addr              \
    ((QCC74x_Err_Type (*) (uintptr_t addr, uint32_t len))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Invalid_By_Addr])

#define RomDriver_L1C_ICache_Disable                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_ICache_Disable])

#define RomDriver_L1C_ICache_Enable                       \
    ((QCC74x_Err_Type (*) (uint8_t wayDsiable))ROM_APITABLE[ROM_API_INDEX_L1C_ICache_Enable])

#define RomDriver_L1C_ICache_Invalid_All                  \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_L1C_ICache_Invalid_All])

#define RomDriver_L1C_ICache_Invalid_By_Addr              \
    ((QCC74x_Err_Type (*) (uintptr_t addr, uint32_t len))ROM_APITABLE[ROM_API_INDEX_L1C_ICache_Invalid_By_Addr])

#define RomDriver_L1C_Set_Cache_Setting_By_ID             \
    ((QCC74x_Err_Type (*) (uint8_t core, L1C_CACHE_Cfg_Type *cacheSetting))ROM_APITABLE[ROM_API_INDEX_L1C_Set_Cache_Setting_By_ID])

#define RomDriver_L1C_Set_Wrap                            \
    ((QCC74x_Err_Type (*) (uint8_t en))ROM_APITABLE[ROM_API_INDEX_L1C_Set_Wrap])

#define RomDriver_L1C_DCache_Write_Set                    \
    ((void (*) (QCC74x_Fun_Type wtEn, QCC74x_Fun_Type wbEn, QCC74x_Fun_Type waEn))ROM_APITABLE[ROM_API_INDEX_L1C_DCache_Write_Set])

#define RomDriver_PDS_Default_Level_Config                \
    ((QCC74x_Err_Type (*) (PDS_DEFAULT_LV_CFG_Type *defaultLvCfg, uint32_t pdsSleepCnt))ROM_APITABLE[ROM_API_INDEX_PDS_Default_Level_Config])

#define RomDriver_PDS_Disable_GPIO_Keep                   \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Disable_GPIO_Keep])

#define RomDriver_PDS_Enable                              \
    ((QCC74x_Err_Type (*) (PDS_CTL_Type *cfg, PDS_CTL4_Type *cfg4, uint32_t pdsSleepCnt))ROM_APITABLE[ROM_API_INDEX_PDS_Enable])

#define RomDriver_PDS_Force_Config                        \
    ((QCC74x_Err_Type (*) (PDS_CTL2_Type *cfg2, PDS_CTL3_Type *cfg3, PDS_CTL5_Type *cfg5))ROM_APITABLE[ROM_API_INDEX_PDS_Force_Config])

#define RomDriver_PDS_IntClear                            \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_IntClear])

#define RomDriver_PDS_IntMask                             \
    ((QCC74x_Err_Type (*) (uint8_t intType, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_PDS_IntMask])

#define RomDriver_PDS_RAM_Config                          \
    ((QCC74x_Err_Type (*) (PDS_CTRL_RAM1_Type *ram1Cfg, PDS_CTRL_RAM2_Type *ram2Cfg, PDS_CTRL_RAM3_Type *ram3Cfg, PDS_CTRL_RAM4_Type *ram4Cfg))ROM_APITABLE[ROM_API_INDEX_PDS_RAM_Config])

#define RomDriver_PDS_Set_Flash_Pad_Pull_None             \
    ((QCC74x_Err_Type (*) (uint8_t pinCfg))ROM_APITABLE[ROM_API_INDEX_PDS_Set_Flash_Pad_Pull_None])

#define RomDriver_PDS_Set_Flash_Pad_Pull_None_Fast        \
    ((QCC74x_Err_Type (*) (uint8_t pinCfg))ROM_APITABLE[ROM_API_INDEX_PDS_Set_Flash_Pad_Pull_None_Fast])

#define RomDriver_PDS_Set_GPIO_Pad_IntClr                 \
    ((QCC74x_Err_Type (*) (uint8_t set))ROM_APITABLE[ROM_API_INDEX_PDS_Set_GPIO_Pad_IntClr])

#define RomDriver_PDS_Set_GPIO_Pad_IntMask                \
    ((QCC74x_Err_Type (*) (uint8_t pad, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_PDS_Set_GPIO_Pad_IntMask])

#define RomDriver_PDS_Set_GPIO_Pad_IntMode                \
    ((QCC74x_Err_Type (*) (uint8_t set, uint8_t trig))ROM_APITABLE[ROM_API_INDEX_PDS_Set_GPIO_Pad_IntMode])

#define RomDriver_PDS_Set_GPIO_Pad_Pn_Pu_Pd_Ie            \
    ((QCC74x_Err_Type (*) (uint8_t grp, uint8_t pu, uint8_t pd, uint8_t ie))ROM_APITABLE[ROM_API_INDEX_PDS_Set_GPIO_Pad_Pn_Pu_Pd_Ie])

#define RomDriver_PDS_Set_MCU0_Clock_Disable              \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Set_MCU0_Clock_Disable])

#define RomDriver_PDS_Set_MCU0_Clock_Enable               \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Set_MCU0_Clock_Enable])

#define RomDriver_PDS_Set_MCU0_Reset_Address              \
    ((QCC74x_Err_Type (*) (uint32_t addr))ROM_APITABLE[ROM_API_INDEX_PDS_Set_MCU0_Reset_Address])

#define RomDriver_PDS_Set_USB_Resume                      \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Set_USB_Resume])

#define RomDriver_PDS_Set_USB_Suspend                     \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Set_USB_Suspend])

#define RomDriver_PDS_Trim_RC32M                          \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Trim_RC32M])

#define RomDriver_PDS_Turn_Off_USB                        \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_PDS_Turn_Off_USB])

#define RomDriver_PDS_Turn_On_USB                         \
    ((QCC74x_Err_Type (*) (uint8_t waitReady))ROM_APITABLE[ROM_API_INDEX_PDS_Turn_On_USB])

#define RomDriver_PDS_Get_GPIO_Pad_IntStatus              \
    ((QCC74x_Sts_Type (*) (uint8_t pad))ROM_APITABLE[ROM_API_INDEX_PDS_Get_GPIO_Pad_IntStatus])

#define RomDriver_PDS_Get_IntStatus                       \
    ((QCC74x_Sts_Type (*) (uint8_t intType))ROM_APITABLE[ROM_API_INDEX_PDS_Get_IntStatus])
...
#define RomDriver_SF_Ctrl_32bits_Addr_En                  \
    ((void (*) (QCC74x_Fun_Type en32BitsAddr))ROM_APITABLE[ROM_API_INDEX_SF_Ctrl_32bits_Addr_En])
...
#define RomDriver_UART_AutoBaudDetection                  \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, QCC74x_Fun_Type autoBaud))ROM_APITABLE[ROM_API_INDEX_UART_AutoBaudDetection])

#define RomDriver_UART_ClrRtsValue                        \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_ClrRtsValue])

#define RomDriver_UART_ClrTxValue                         \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_ClrTxValue])

#define RomDriver_UART_DeInit                             \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_DeInit])

#define RomDriver_UART_Disable                            \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_Direction_Type direct))ROM_APITABLE[ROM_API_INDEX_UART_Disable])

#define RomDriver_UART_Enable                             \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_Direction_Type direct))ROM_APITABLE[ROM_API_INDEX_UART_Enable])

#define RomDriver_UART_FifoConfig                         \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_FifoCfg_Type *fifoCfg))ROM_APITABLE[ROM_API_INDEX_UART_FifoConfig])

#define RomDriver_UART_GetBitWidth0X55                    \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint16_t *width))ROM_APITABLE[ROM_API_INDEX_UART_GetBitWidth0X55])

#define RomDriver_UART_Init                               \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_CFG_Type *uartCfg))ROM_APITABLE[ROM_API_INDEX_UART_Init])

#define RomDriver_UART_IntClear                           \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_INT_Type intType))ROM_APITABLE[ROM_API_INDEX_UART_IntClear])

#define RomDriver_UART_IntMask                            \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_INT_Type intType, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_UART_IntMask])

#define RomDriver_UART_IrConfig                           \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_IrCfg_Type *irCfg))ROM_APITABLE[ROM_API_INDEX_UART_IrConfig])

#define RomDriver_UART_RxFifoClear                        \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_RxFifoClear])

#define RomDriver_UART_SendData                           \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint8_t *data, uint32_t len))ROM_APITABLE[ROM_API_INDEX_UART_SendData])

#define RomDriver_UART_SendDataBlock                      \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint8_t *data, uint32_t len))ROM_APITABLE[ROM_API_INDEX_UART_SendDataBlock])

#define RomDriver_UART_SetAllowableError0X55              \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint8_t allowableError))ROM_APITABLE[ROM_API_INDEX_UART_SetAllowableError0X55])

#define RomDriver_UART_SetBaudrate                        \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, UART_AutoBaudDetection_Type autoBaudDet))ROM_APITABLE[ROM_API_INDEX_UART_SetBaudrate])

#define RomDriver_UART_SetDeglitchCount                   \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint8_t deglitchCnt))ROM_APITABLE[ROM_API_INDEX_UART_SetDeglitchCount])

#define RomDriver_UART_SetRS485                           \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, QCC74x_Fun_Type enable, UART_RS485Polarity_Type polarity))ROM_APITABLE[ROM_API_INDEX_UART_SetRS485])

#define RomDriver_UART_SetRtsValue                        \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_SetRtsValue])

#define RomDriver_UART_SetRxByteCount                     \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint16_t count))ROM_APITABLE[ROM_API_INDEX_UART_SetRxByteCount])

#define RomDriver_UART_SetRxDataLength                    \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint16_t length))ROM_APITABLE[ROM_API_INDEX_UART_SetRxDataLength])

#define RomDriver_UART_SetRxTimeoutValue                  \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint8_t time))ROM_APITABLE[ROM_API_INDEX_UART_SetRxTimeoutValue])

#define RomDriver_UART_SetTxDataLength                    \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, uint16_t length))ROM_APITABLE[ROM_API_INDEX_UART_SetTxDataLength])

#define RomDriver_UART_SetTxValue                         \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_SetTxValue])

#define RomDriver_UART_TxFifoClear                        \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_TxFifoClear])

#define RomDriver_UART_TxFreeRun                          \
    ((QCC74x_Err_Type (*) (UART_ID_Type uartId, QCC74x_Fun_Type txFreeRun))ROM_APITABLE[ROM_API_INDEX_UART_TxFreeRun])

#define RomDriver_UART_GetIntStatus                       \
    ((QCC74x_Sts_Type (*) (UART_ID_Type uartId, UART_INT_Type intType))ROM_APITABLE[ROM_API_INDEX_UART_GetIntStatus])

#define RomDriver_UART_GetOverflowStatus                  \
    ((QCC74x_Sts_Type (*) (UART_ID_Type uartId, UART_Overflow_Type overflow))ROM_APITABLE[ROM_API_INDEX_UART_GetOverflowStatus])

#define RomDriver_UART_GetRxBusBusyStatus                 \
    ((QCC74x_Sts_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_GetRxBusBusyStatus])

#define RomDriver_UART_GetTxBusBusyStatus                 \
    ((QCC74x_Sts_Type (*) (UART_ID_Type uartId))ROM_APITABLE[ROM_API_INDEX_UART_GetTxBusBusyStatus])
...
#define RomDriver_XIP_SFlash_Erase_Need_Lock              \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint32_t startaddr, int len, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_Erase_Need_Lock])

#define RomDriver_XIP_SFlash_GetDeviceId_Need_Lock        \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, QCC74x_Fun_Type is32BitsAddr, uint8_t *data, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_GetDeviceId_Need_Lock])

#define RomDriver_XIP_SFlash_GetJedecId_Need_Lock         \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint8_t *data, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_GetJedecId_Need_Lock])

#define RomDriver_XIP_SFlash_GetUniqueId_Need_Lock        \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint8_t *data, uint8_t idLen, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_GetUniqueId_Need_Lock])

#define RomDriver_XIP_SFlash_Read_Need_Lock               \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_Read_Need_Lock])

#define RomDriver_XIP_SFlash_Read_Via_Cache_Need_Lock     \
    ((QCC74x_Err_Type (*) (uint32_t addr, uint8_t *data, uint32_t len))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_Read_Via_Cache_Need_Lock])

#define RomDriver_XIP_SFlash_State_Restore                \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint32_t offset, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_State_Restore])

#define RomDriver_XIP_SFlash_State_Save                   \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint32_t *offset, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_State_Save])

#define RomDriver_XIP_SFlash_Write_Need_Lock              \
    ((QCC74x_Err_Type (*) (spi_flash_cfg_type *pFlashCfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank))ROM_APITABLE[ROM_API_INDEX_XIP_SFlash_Write_Need_Lock])
...
#define RomDriver_MD_Clr_GPIO_IntStatus                   \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_Clr_GPIO_IntStatus])

#define RomDriver_MD_Embedded_Flash_Pad_Enable            \
    ((QCC74x_Err_Type (*) (void))ROM_APITABLE[ROM_API_INDEX_MD_Embedded_Flash_Pad_Enable])

#define RomDriver_MD_GPIO_Clr                             \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Clr])

#define RomDriver_MD_GPIO_Init                            \
    ((QCC74x_Err_Type (*) (MD_GPIO_Cfg_Type *cfg))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Init])

#define RomDriver_MD_GPIO_Input_Disable                   \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Input_Disable])

#define RomDriver_MD_GPIO_Input_Enable                    \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Input_Enable])

#define RomDriver_MD_GPIO_IntMask                         \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin, QCC74x_Mask_Type intMask))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_IntMask])

#define RomDriver_MD_GPIO_Int_Init                        \
    ((QCC74x_Err_Type (*) (MD_GPIO_INT_Cfg_Type *intCfg))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Int_Init])

#define RomDriver_MD_GPIO_Output_Disable                  \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Output_Disable])

#define RomDriver_MD_GPIO_Output_Enable                   \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Output_Enable])

#define RomDriver_MD_GPIO_Set                             \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Set])

#define RomDriver_MD_GPIO_Set_HZ                          \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Set_HZ])

#define RomDriver_MD_GPIO_Write                           \
    ((QCC74x_Err_Type (*) (MD_GPIO_Type gpioPin, uint32_t val))ROM_APITABLE[ROM_API_INDEX_MD_GPIO_Write])

#define RomDriver_MD_Get_GPIO_IntStatus                   \
    ((QCC74x_Sts_Type (*) (MD_GPIO_Type gpioPin))ROM_APITABLE[ROM_API_INDEX_MD_Get_GPIO_IntStatus])
