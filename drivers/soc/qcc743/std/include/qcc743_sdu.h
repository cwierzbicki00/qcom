#ifndef __QCC743_SDU_H__
#define __QCC743_SDU_H__
...
// SDIO I/O Enable
#define QCC74x_SDIO_IO_ENABLE           SDU_BASE + 0x00000002 
//CCCR (Fn0) Registers

// SDIO Device Sleep
#define QCC74x_SDIO_DEV_SLEEP           SDU_BASE + 0x00000092

// Start Address of CCR
#define QCC74x_SDIO_CCR_BASE            SDU_BASE + 0x00000100
...
#define QCC74x_FUNC_SCRATCH_BASE       SDU_BASE + 0x00000160
...
#define QCC74x_REGS8(x)     (*(volatile unsigned char *)(x))
#define QCC74x_REGS16(x)    (*(volatile unsigned short *)(x))
#define QCC74x_REGS32(x)    (*(volatile unsigned long *)(x))

#define QCC74x_READ_REGS8(reg,val)      ((val) = QCC74x_REGS8(reg))
#define QCC74x_READ_REGS16(reg,val)     ((val) = QCC74x_REGS16(reg))
#define QCC74x_READ_REGS32(reg,val)     ((val) = QCC74x_REGS32(reg))
#define QCC74x_READ_BYTE(reg,val)       ((val) = QCC74x_REGS8(reg))
#define QCC74x_READ_HWORD(reg,val)      ((val) = QCC74x_REGS16(reg)) /*half word; */
#define QCC74x_READ_WORD(reg,val)       ((val) = QCC74x_REGS32(reg)) /*32 bits */

#define QCC74x_WRITE_REGS8(reg,val)     (QCC74x_REGS8(reg) = (val))
#define QCC74x_WRITE_REGS16(reg,val)    (QCC74x_REGS16(reg) = (val))
#define QCC74x_WRITE_REGS32(reg,val)    (QCC74x_REGS32(reg) = (val))
#define QCC74x_WRITE_BYTE(reg,val)      (QCC74x_REGS8(reg) = (val))
#define QCC74x_WRITE_HWORD(reg,val)     (QCC74x_REGS16(reg) = (val))  /*half word; */
#define QCC74x_WRITE_WORD(reg,val)      (QCC74x_REGS32(reg) = (val))  /*32 bits */
// Write uint32 to a low 16-bit register and a high 16-bit register
#define WRITE2REGS(lo,hi,u32) \
    QCC74x_WRITE_HWORD(lo, (uint16_t)((u32) & 0xffff)); \
    QCC74x_WRITE_HWORD(hi, (uint16_t)(((u32) >> 16) & 0xffff))

#define QCC74x_REGS8_SETBITS(reg, val)  (QCC74x_REGS8(reg) |= (uint8)(val))
#define QCC74x_REGS16_SETBITS(reg, val) (QCC74x_REGS16(reg) |= (uint16)(val))
#define QCC74x_REGS32_SETBITS(reg, val) (QCC74x_REGS32(reg) |= (val))
#define QCC74x_REGS8_CLRBITS(reg, val)  (QCC74x_REGS8(reg) = (uint8)(QCC74x_REGS8(reg)&~(val)))
#define QCC74x_REGS16_CLRBITS(reg, val) (QCC74x_REGS16(reg) = (uint16)(QCC74x_REGS16(reg)&~(val)))
#define QCC74x_REGS32_CLRBITS(reg, val) (QCC74x_REGS32(reg) = (QCC74x_REGS32(reg)&~(val)))
