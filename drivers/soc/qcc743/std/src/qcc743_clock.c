...
static uint32_t ATTR_CLOCK_SECTION Clock_Get_AUPLL_Output(CLOCK_AUPLL_Type clockAupllType)
{
    ...
    tmpVal = QCC74x_GET_REG_BITS_VAL(QCC74x_RD_REG(CCI_BASE, CCI_AUDIO_PLL_CFG6), CCI_AUPLL_SDMIN);
...
static inline uint32_t ATTR_CLOCK_SECTION Clock_Get_Audio_PLL_Output()
{
    ...
    tmpVal = QCC74x_GET_REG_BITS_VAL(QCC74x_RD_REG(CCI_BASE, CCI_AUDIO_PLL_CFG1), CCI_AUPLL_POSTDIV);
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_F32k_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, HBN_F32K_SEL);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Muxpll_160M_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_160M_SEL);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Muxpll_80M_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_80M_SEL);
}
...
static inline uint32_t ATTR_CLOCK_SECTION Clock_MCU_Root_Clk_Mux_Output(uint8_t sel)
{
    ...
    if (sel == 0) {
        ...
        sel = QCC74x_GET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL);
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_MCU_HClk_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_HCLK_DIV);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Peri_BClk_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_BCLK_DIV);
}
 ...
 *
*******************************************************************************/
uint32_t ATTR_CLOCK_SECTION Clock_System_Clock_Get(QCC74x_System_Clock_Type type)
{
    uint32_t clock = 0;
    uint32_t div = 0;
...
static inline uint8_t Clock_Get_PSRAMB_Clk_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_DIV);
}
...
static inline uint8_t Clock_Get_PSRAMB_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_SEL);
}
...
static inline uint8_t Clock_Get_ISP_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_ISP_MUXPLL_80M_SEL);
}
...
static inline uint8_t Clock_Get_UART_Clk_Sel_Val(void)
{
    ...
    return ((QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_HBN_UART_CLK_SEL2) << 1) | QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_HBN_UART_CLK_SEL));
}
...
static inline uint8_t Clock_Get_UART_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_UART_CLK_DIV);
}
...
static inline uint8_t Clock_Get_PKA_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_PKA_CLK_SEL);
}
...
static inline uint8_t Clock_Get_IR_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_IR_CLK_DIV);
}
...
static inline uint8_t Clock_Get_SPI_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_SEL);
}
...
static inline uint8_t Clock_Get_SPI_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_DIV);
}
...
static inline uint8_t Clock_Get_DBI_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_SEL);
}
...
static inline uint8_t Clock_Get_DBI_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_DIV);
}
...
static inline uint8_t Clock_Get_I2C_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_SEL);
}
...
static inline uint8_t Clock_Get_I2C_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_DIV);
}
...
static inline uint8_t Clock_Get_GPADC_32M_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_SEL);
}
...
static inline uint8_t Clock_Get_GPADC_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_DIV);
}
...
static inline uint8_t Clock_Get_I2S_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_I2S_REF_CLK_DIV);
}
...
static inline uint8_t Clock_Get_ADC_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_AUDIO_SOLO_CLK_DIV);
}
...
static inline uint8_t Clock_Get_GPADC_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, HBN_GPADC_CS);
}
...
static inline uint8_t Clock_Get_GPDAC_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_DIG_512K_DIV);
}
...
static inline uint8_t Clock_Get_GPDAC_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_DIG_CLK_SRC_SEL);
}
...
static inline uint8_t Clock_Get_SDH_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_SEL);
}
...
static inline uint8_t Clock_Get_SDH_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_DIV);
}
...
static inline uint8_t Clock_Get_CAM_Clk_Sel_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_SRC_SEL);
}
...
static inline uint8_t Clock_Get_CAM_Div_Val(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_DIV);
}
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION CPU_Set_MTimer_RST(uint8_t rstEn)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    /* DSP RTC_RST is [30] */
    /* LP  RTC_RST is [30] */
    tmpVal = QCC74x_RD_WORD(address);
    if (rstEn) {
        tmpVal = QCC74x_SET_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_RST);
    } else {
        tmpVal = QCC74x_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_RST);
    }
    QCC74x_WR_WORD(address, tmpVal);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION CPU_Reset_MTimer(void)
{
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION CPU_Set_MTimer_CLK(uint8_t enable, QCC74x_MTimer_Source_Clock_Type mTimerSourceClockType, uint16_t div)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    tmpVal = QCC74x_RD_WORD(address);
    tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_CLK_SEL, mTimerSourceClockType);
    QCC74x_WR_WORD(address, tmpVal);
    ...
    /* LP  RTC_EN is [31] */
    tmpVal = QCC74x_RD_WORD(address);
    tmpVal = QCC74x_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    QCC74x_WR_WORD(address, tmpVal);
    ...
    /* LP  RTC_DIV is [9:0] */
    tmpVal = QCC74x_RD_WORD(address);
    tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_DIV, div);
    QCC74x_WR_WORD(address, tmpVal);
    ...
    tmpVal = QCC74x_RD_WORD(address);
    if (enable) {
        tmpVal = QCC74x_SET_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    } else {
        tmpVal = QCC74x_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    }
    QCC74x_WR_WORD(address, tmpVal);
...
uint32_t ATTR_CLOCK_SECTION CPU_Get_MTimer_Source_Clock(void)
{
    ...
    tmpVal = QCC74x_RD_REG(MCU_MISC_BASE, MCU_MISC_MCU_E907_RTC);
    tmpVal = QCC74x_GET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_CLK_SEL);
...
uint32_t ATTR_CLOCK_SECTION CPU_Get_MTimer_Clock(void)
{
    ...
    /* DSP RTC_DIV is [9:0] */
    /* LP  RTC_DIV is [9:0] */
    div = QCC74x_GET_REG_BITS_VAL(QCC74x_RD_WORD(address), MCU_MISC_REG_MCU_RTC_DIV);
    div += 1;
    coreFreq = coreFreq ? coreFreq : (32 * 1000 * 1000);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION CPU_MTimer_Delay_US(uint32_t cnt)
{
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION CPU_MTimer_Delay_MS(uint32_t cnt)
{
