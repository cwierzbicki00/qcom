 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION AON_Power_On_MBG(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION AON_Power_Off_MBG(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION AON_Power_On_XTAL(void)
{
    uint32_t tmpVal = 0;
    uint32_t timeOut = 0;

    tmpVal = QCC74x_RD_REG(AON_BASE, AON_RF_TOP_AON);
    tmpVal = QCC74x_SET_REG_BIT(tmpVal, AON_PU_XTAL_AON);
    tmpVal = QCC74x_SET_REG_BIT(tmpVal, AON_PU_XTAL_BUF_AON);
    QCC74x_WR_REG(AON_BASE, AON_RF_TOP_AON, tmpVal);
    ...
    } while (!QCC74x_IS_REG_BIT_SET(tmpVal, AON_XTAL_RDY) && timeOut < 120);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION AON_Set_Xtal_CapCode(uint8_t capIn, uint8_t capOut)
{
    uint32_t tmpVal = 0;

    tmpVal = QCC74x_RD_REG(AON_BASE, AON_XTAL_CFG);
    tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_XTAL_CAPCODE_IN_AON, capIn);
    tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_XTAL_CAPCODE_OUT_AON, capOut);
...
uint8_t ATTR_CLOCK_SECTION AON_Get_Xtal_CapCode(void)
{
    ...
    return QCC74x_GET_REG_BITS_VAL(tmpVal, AON_XTAL_CAPCODE_IN_AON);
}
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_CLOCK_SECTION AON_Power_Off_XTAL(void)
{
    uint32_t tmpVal = 0;

    tmpVal = QCC74x_RD_REG(AON_BASE, AON_RF_TOP_AON);
    tmpVal = QCC74x_CLR_REG_BIT(tmpVal, AON_PU_XTAL_AON);
    tmpVal = QCC74x_CLR_REG_BIT(tmpVal, AON_PU_XTAL_BUF_AON);
    QCC74x_WR_REG(AON_BASE, AON_RF_TOP_AON, tmpVal);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_On_BG(void)
{
    uint32_t tmpVal = 0;

    /* power up RF for PLL to work */
    tmpVal = QCC74x_RD_REG(AON_BASE, AON_BG_SYS_TOP);
    tmpVal = QCC74x_SET_REG_BIT(tmpVal, AON_PU_BG_SYS_AON);
    QCC74x_WR_REG(AON_BASE, AON_BG_SYS_TOP, tmpVal);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_Off_BG(void)
{
    uint32_t tmpVal = 0;

    /* power up RF for PLL to work */
    tmpVal = QCC74x_RD_REG(AON_BASE, AON_BG_SYS_TOP);
    tmpVal = QCC74x_CLR_REG_BIT(tmpVal, AON_PU_BG_SYS_AON);
    QCC74x_WR_REG(AON_BASE, AON_BG_SYS_TOP, tmpVal);
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_On_LDO15_RF(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_Off_LDO15_RF(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_On_SFReg(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Power_Off_SFReg(void)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Trim_DcdcDis(void)
{
    ...
    if (trim.dcdcDisAonEn) {
        if (trim.dcdcDisAonParity == EF_Ctrl_Get_Trim_Parity(trim.dcdcDisAon, 1)) {
            tmpVal = QCC74x_RD_REG(AON_BASE, AON_DCDC_TOP_0);
            tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_DCDC_DIS_AON, trim.dcdcDisAon);
            QCC74x_WR_REG(AON_BASE, AON_DCDC_TOP_0, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Trim_DcdcVoutSel(void)
{
    ...
    if (trim.dcdcVoutSelAonEn) {
        if (trim.dcdcVoutSelAonParity == EF_Ctrl_Get_Trim_Parity(trim.dcdcVoutSelAon, 5)) {
            tmpVal = QCC74x_RD_REG(AON_BASE, AON_DCDC_TOP_0);
            tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_DCDC_VOUT_SEL_AON, trim.dcdcVoutSelAon);
            QCC74x_WR_REG(AON_BASE, AON_DCDC_TOP_0, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Trim_DcdcVoutTrim(void)
{
    ...
    if (trim.dcdcVoutTrimAonEn) {
        if (trim.dcdcVoutTrimAonParity == EF_Ctrl_Get_Trim_Parity(trim.dcdcVoutTrimAon, 4)) {
            tmpVal = QCC74x_RD_REG(AON_BASE, AON_DCDC_TOP_2);
            tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_DCDC_VOUT_TRIM_AON, trim.dcdcVoutTrimAon);
            QCC74x_WR_REG(AON_BASE, AON_DCDC_TOP_2, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Trim_Ldo11socVoutTrim(void)
{
    ...
    if (trim.ldo11socVoutTrimAonEn) {
        if (trim.ldo11socVoutTrimAonTrim == EF_Ctrl_Get_Trim_Parity(trim.ldo11socVoutTrimAon, 4)) {
            tmpVal = QCC74x_RD_REG(AON_BASE, AON_LDO11SOC_AND_DCTEST);
            tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_LDO11SOC_VOUT_TRIM_AON, trim.ldo11socVoutTrimAon);
            QCC74x_WR_REG(AON_BASE, AON_LDO11SOC_AND_DCTEST, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QCC74x_Err_Type ATTR_TCM_SECTION AON_Trim_Usb20RcalCode(void)
{
    ...
    if (trim.usb20RcalCodeAonEn) {
        if (trim.usb20RcalCodeAonParity == EF_Ctrl_Get_Trim_Parity(trim.usb20RcalCodeAon, 6)) {
            tmpVal = QCC74x_RD_REG(AON_BASE, AON_PSW_MISC);
            tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, AON_USB20_RCAL_CODE_AON, trim.usb20RcalCodeAon);
            QCC74x_WR_REG(AON_BASE, AON_PSW_MISC, tmpVal);
            return SUCCESS;
        }
    }
