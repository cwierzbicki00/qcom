...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type HBN_Set_Flash_Power_Delay(uint8_t flashPwrDly){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_sf_cfg_get_flash_cfg_need_lock(uint32_t flash_id, spi_flash_cfg_type *flash_cfg){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_erase_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t start_addr, int len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_getdeviceid_need_lock(spi_flash_cfg_type *flash_cfg, QCC74x_Fun_Type is_32bits_addr, uint8_t *data, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_getjedecid_need_lock(spi_flash_cfg_type *flash_cfg, uint8_t *data, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_getuniqueid_need_lock(spi_flash_cfg_type *flash_cfg, uint8_t *data, uint8_t id_len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_read_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_state_save(spi_flash_cfg_type *flash_cfg, uint32_t *offset, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qcc74x_xip_sflash_write_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_Clr_GPIO_IntStatus(MD_GPIO_Type gpioPin){
    return RomDriver_MD_Clr_GPIO_IntStatus(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_Embedded_Flash_Pad_Enable(void){
    return RomDriver_MD_Embedded_Flash_Pad_Enable();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Clr(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Clr(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Init(MD_GPIO_Cfg_Type *cfg){
    return RomDriver_MD_GPIO_Init(cfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Input_Disable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Input_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Input_Enable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Input_Enable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_IntMask(MD_GPIO_Type gpioPin, QCC74x_Mask_Type intMask){
    return RomDriver_MD_GPIO_IntMask(gpioPin,intMask);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Int_Init(MD_GPIO_INT_Cfg_Type *intCfg){
    return RomDriver_MD_GPIO_Int_Init(intCfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Output_Disable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Output_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Output_Enable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Output_Enable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Set(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Set(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Set_HZ(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Set_HZ(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Err_Type MD_GPIO_Write(MD_GPIO_Type gpioPin, uint32_t val){
    return RomDriver_MD_GPIO_Write(gpioPin,val);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QCC74x_Sts_Type MD_Get_GPIO_IntStatus(MD_GPIO_Type gpioPin){
