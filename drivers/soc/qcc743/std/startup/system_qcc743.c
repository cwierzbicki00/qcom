...
void SystemInit(void)
{
    ...
    *(volatile uint32_t *)(0x2000e504) = 0;
    ...
    if (em_size == 0) {
        tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x00); // GLB_WRAM160KB_EM0KB
    } else if (em_size == 32 * 1024) {
        tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x03); // GLB_WRAM128KB_EM32KB
    } else if (em_size == 64 * 1024) {
        tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x0f); // GLB_WRAM96KB_EM64KB
    } else {
        tmpVal = QCC74x_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x00); // GLB_WRAM160KB_EM0KB
    }
