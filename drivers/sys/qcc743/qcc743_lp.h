#ifndef __QCC743_LP_H__
#define __QCC743_LP_H__
#include <stdint.h>
...
#define QCC74x_LP_WAKEUP_IO_MAX_NUM                    35

/** @defgroup QCC74x_LP_IO_INPUT_EN input enable
  * @{
  */
#define QCC74x_LP_IO_INPUT_DISABLE                     0
#define QCC74x_LP_IO_INPUT_ENABLE                      1
/**
  * @}
  */

/** @defgroup QCC74x_LP_AON_IO_TRIG aon io wakeup trigger mode
  * @{
  */
#define QCC74x_LP_AON_IO_TRIG_SYNC_FALLING_EDGE        (0x0) /*!< AON_IO INT trigger type: sync falling edge trigger */
#define QCC74x_LP_AON_IO_TRIG_SYNC_RISING_EDGE         (0x1) /*!< AON_IO INT trigger type: sync rising edge trigger */
#define QCC74x_LP_AON_IO_TRIG_SYNC_LOW_LEVEL           (0x2) /*!< AON_IO INT trigger type: sync low level trigger */
#define QCC74x_LP_AON_IO_TRIG_SYNC_HIGH_LEVEL          (0x3) /*!< AON_IO INT trigger type: sync high level trigger */
#define QCC74x_LP_AON_IO_TRIG_SYNC_RISING_FALLING_EDGE (0x4) /*!< AON_IO INT trigger type: sync rising falling edge trigger */
#define QCC74x_LP_AON_IO_TRIG_ASYNC_FALLING_EDGE       (0x8) /*!< AON_IO INT trigger type: async falling edge trigger */
#define QCC74x_LP_AON_IO_TRIG_ASYNC_RISING_EDGE        (0x9) /*!< AON_IO INT trigger type: async rising edge trigger */
#define QCC74x_LP_AON_IO_TRIG_ASYNC_LOW_LEVEL          (0xA) /*!< AON_IO INT trigger type: async low level trigger */
#define QCC74x_LP_AON_IO_TRIG_ASYNC_HIGH_LEVEL         (0xB) /*!< AON_IO INT trigger type: async high level trigger */
#define QCC74x_LP_AON_IO_TRIG_NONE                     (0xF) /*!< AON_IO INT trigger type: none */
/**
  * @}
  */

/** @defgroup QCC74x_LP_PDS_IO_TRIG aon io wakeup trigger mode
  * @{
  */
#define QCC74x_LP_PDS_IO_TRIG_SYNC_FALLING_EDGE        (0x0) /*!< PDS_IO INT trigger type: sync falling edge trigger */
#define QCC74x_LP_PDS_IO_TRIG_SYNC_RISING_EDGE         (0x1) /*!< PDS_IO INT trigger type: sync rising edge trigger */
#define QCC74x_LP_PDS_IO_TRIG_SYNC_HIGH_LEVEL          (0x3) /*!< PDS_IO INT trigger type: sync high level trigger */
#define QCC74x_LP_PDS_IO_TRIG_ASYNC_FALLING_EDGE       (0x8) /*!< PDS_IO INT trigger type: async falling edge trigger */
#define QCC74x_LP_PDS_IO_TRIG_ASYNC_RISING_EDGE        (0x9) /*!< PDS_IO INT trigger type: async rising edge trigger */
#define QCC74x_LP_PDS_IO_TRIG_ASYNC_HIGH_LEVEL         (0xB) /*!< PDS_IO INT trigger type: async high level trigger */
#define QCC74x_LP_PDS_IO_TRIG_NONE                     (0xF) /*!< PDS_IO INT trigger type: none */
/**
  * @}
  */

/** @defgroup QCC74x_LP_RES resistors select
  * @{
  */
#define QCC74x_LP_IO_RES_PULL_UP                       1
#define QCC74x_LP_IO_RES_PULL_DOWN                     2
#define QCC74x_LP_IO_RES_NONE                          3
/**
  * @}
  */
...
typedef struct {
    ...
    /* trigger mode */
    uint8_t io_0_7_pds_trig_mode;   /* use @ref QCC74x_LP_PDS_IO_TRIG */
    uint8_t io_8_15_pds_trig_mode;  /* use @ref QCC74x_LP_PDS_IO_TRIG */
    uint8_t io_16_19_aon_trig_mode; /* aon io, use @ref QCC74x_LP_AON_IO_TRIG, full mode support */
    uint8_t io_20_27_pds_trig_mode; /* use @ref QCC74x_LP_PDS_IO_TRIG */
    uint8_t io_28_34_pds_trig_mode; /* use @ref QCC74x_LP_PDS_IO_TRIG */
...
#define QCC74x_LP_IO_WAKEUP_MODE_LOW             1
#define QCC74x_LP_IO_WAKEUP_MODE_HIGH            2
#define QCC74x_LP_IO_WAKEUP_MODE_FALLING         3
#define QCC74x_LP_IO_WAKEUP_MODE_RISING          4

/******************** acomp wakeup cfg ********************/

#define QCC74x_LP_WAKEUP_ACOMP_MAX_NUM           2

/** @defgroup QCC74x_LP_ACOMP_EN acomp input enable
  * @{
  */
#define QCC74x_LP_ACOMP_DISABLE                  0
#define QCC74x_LP_ACOMP_ENABLE                   1
/**
  * @}
  */

/** @defgroup QCC74x_LP_ACOMP_TRIG acomp wakeup trigger mode
  * @{
  */
#define QCC74x_LP_ACOMP_TRIG_EDGE_FALLING        1
#define QCC74x_LP_ACOMP_TRIG_EDGE_RISING         2
#define QCC74x_LP_ACOMP_TRIG_EDGE_FALLING_RISING 3
/**
  * @}
  */
...
#define QCC74x_LP_ACOMP_WAKEUP_MODE_FALLING 1
#define QCC74x_LP_ACOMP_WAKEUP_MODE_RISING  2

/******************** acomp end ********************/

#define QCC74x_LP_SOFT_INT_TRIG             (csi_vic_set_pending_irq(MSOFT_IRQn))
#define QCC74x_LP_SOFT_INT_CLEAR            (csi_vic_clear_pending_irq(MSOFT_IRQn))
