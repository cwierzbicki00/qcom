...
{
#ifdef romapi_qcc74x_sha_init
    romapi_qcc74x_sha_init(dev, mode);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha1_start
    romapi_qcc74x_sha1_start(dev, ctx);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha256_start
    romapi_qcc74x_sha256_start(dev, ctx);
#else
...
{
#ifdef romapi_qcc74x_sha512_start
    romapi_qcc74x_sha512_start(dev, ctx);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha1_update
    return romapi_qcc74x_sha1_update(dev, ctx, input, len);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint32_t fill;
...
int qcc74x_sha256_update(struct qcc74x_device_s *dev, struct qcc74x_sha256_ctx_s *ctx, const uint8_t *input, uint32_t len)
{
    ...
    return romapi_qcc74x_sha256_update(dev, ctx, input, len);
#else
...
{
#ifdef romapi_qcc74x_sha512_update
    return romapi_qcc74x_sha512_update(dev, ctx, input, len);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint32_t fill;
...
{
#ifdef romapi_qcc74x_sha1_finish
    romapi_qcc74x_sha1_finish(dev, ctx, output);
#else
    uint32_t last, padn;
    uint32_t high, low;
    uint8_t msgLen[8];
...
{
#ifdef romapi_qcc74x_sha256_finish
    romapi_qcc74x_sha256_finish(dev, ctx, output);
#else
...
{
#ifdef romapi_qcc74x_sha512_finish
    romapi_qcc74x_sha512_finish(dev, ctx, output);
#else
    uint64_t last, padn;
    uint64_t high, low;
    uint8_t msgLen[16];
...
{
#ifdef romapi_qcc74x_sha_link_init
    romapi_qcc74x_sha_link_init(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha_link_deinit
    romapi_qcc74x_sha_link_deinit(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha1_link_start
    romapi_qcc74x_sha1_link_start(dev, ctx);
#else
...
{
#ifdef romapi_qcc74x_sha256_link_start
    romapi_qcc74x_sha256_link_start(dev, ctx, is224);
#else
    arch_memset(ctx, 0, sizeof(struct qcc74x_sha1_link_ctx_s));
    ctx->sha_padding[0] = 0x80;
    ctx->link_addr = (uint32_t)(uintptr_t)&ctx->link_cfg;
...
{
#ifdef romapi_qcc74x_sha512_link_start
    romapi_qcc74x_sha512_link_start(dev, ctx, is384);
#else
...
int qcc74x_sha1_link_update(struct qcc74x_device_s *dev,
                          ...
                          uint32_t len)
{
#ifdef romapi_qcc74x_sha1_link_update
    return romapi_qcc74x_sha1_link_update(dev, ctx, input, len);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint32_t fill;
...
int qcc74x_sha256_link_update(struct qcc74x_device_s *dev,
                            ...
                            uint32_t len)
{
#ifdef romapi_qcc74x_sha256_link_update
    return romapi_qcc74x_sha256_link_update(dev, ctx, input, len);
#else
...
int qcc74x_sha512_link_update(struct qcc74x_device_s *dev,
                            ...
                            uint64_t len)
{
#ifdef romapi_qcc74x_sha512_link_update
    return romapi_qcc74x_sha512_link_update(dev, ctx, input, len);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint32_t fill;
...
void qcc74x_sha1_link_finish(struct qcc74x_device_s *dev,
                           ...
                           uint8_t *output)
{
#ifdef romapi_qcc74x_sha1_link_finish
    return romapi_qcc74x_sha1_link_finish(dev, ctx, output);
#else
    uint32_t last, padn;
    uint32_t high, low;
    uint8_t msgLen[8];
...
void qcc74x_sha256_link_finish(struct qcc74x_device_s *dev,
                             ...
                             uint8_t *output)
{
#ifdef romapi_qcc74x_sha256_link_finish
    return romapi_qcc74x_sha256_link_finish(dev, ctx, output);
#else
...
void qcc74x_sha512_link_finish(struct qcc74x_device_s *dev,
                             ...
                             uint8_t *output)
{
#ifdef romapi_qcc74x_sha512_link_finish
    romapi_qcc74x_sha512_link_finish(dev, ctx, output);
#else
    uint64_t last, padn;
    uint64_t high, low;
    uint8_t msgLen[16];
...
{
#ifdef romapi_qcc74x_group0_request_sha_access
    return romapi_qcc74x_group0_request_sha_access(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_group0_release_sha_access
    return romapi_qcc74x_group0_release_sha_access(dev);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_sha_crc32_link_work
    return romapi_qcc74x_sha_crc32_link_work(dev, addr, in, len, out);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint64_t start_time;
