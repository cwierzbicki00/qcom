...
void qcc74x_adc_link_rxdma(struct qcc74x_device_s *dev, bool enable)
{
    uint32_t regval;
...
void qcc74x_adc_rxint_mask(struct qcc74x_device_s *dev, bool mask)
{
    uint32_t regval;
...
void qcc74x_adc_errint_mask(struct qcc74x_device_s *dev, bool mask)
{
    uint32_t regval;
    uint32_t regval2;
    uint32_t reg_base;
