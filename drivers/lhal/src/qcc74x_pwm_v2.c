...
void qcc74x_pwm_v2_init(struct qcc74x_device_s *dev, const struct qcc74x_pwm_v2_config_s *config)
{
...
#ifdef romapi_qcc74x_pwm_v2_init
    romapi_qcc74x_pwm_v2_init(dev, config);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
    ...
    if (config->clk_source == QCC74x_SYSTEM_XCLK) {
        regval |= (0 << PWM_REG_CLK_SEL_SHIFT);
    } else if (config->clk_source == QCC74x_SYSTEM_PBCLK) {
        regval |= (1 << PWM_REG_CLK_SEL_SHIFT);
    } else if (config->clk_source == QCC74x_SYSTEM_32K_CLK) {
...
{
#ifdef romapi_qcc74x_pwm_v2_deinit
    romapi_qcc74x_pwm_v2_deinit(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
{
#ifdef romapi_qcc74x_pwm_v2_set_period
    romapi_qcc74x_pwm_v2_set_period(dev, period);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_start
    romapi_qcc74x_pwm_v2_start(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
{
#ifdef romapi_qcc74x_pwm_v2_stop
    romapi_qcc74x_pwm_v2_stop(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
{
#ifdef romapi_qcc74x_pwm_v2_get_frequency
    return romapi_qcc74x_pwm_v2_get_frequency(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint32_t tmp;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_init
    romapi_qcc74x_pwm_v2_channel_init(dev, ch, config);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_set_threshold
    romapi_qcc74x_pwm_v2_channel_set_threshold(dev, ch, low_threhold, high_threhold);
#else
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_positive_start
    romapi_qcc74x_pwm_v2_channel_positive_start(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_negative_start
    romapi_qcc74x_pwm_v2_channel_negative_start(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_positive_stop
    romapi_qcc74x_pwm_v2_channel_positive_stop(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_pwm_v2_channel_negative_stop
    romapi_qcc74x_pwm_v2_channel_negative_stop(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_pwm_v2_int_enable(struct qcc74x_device_s *dev, uint32_t int_en, bool enable)
{
#ifdef romapi_qcc74x_pwm_v2_int_enable
    romapi_qcc74x_pwm_v2_int_enable(dev, int_en, enable);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_pwm_v2_int_clear
    romapi_qcc74x_pwm_v2_int_clear(dev, int_clear);
#else
...
{
#ifdef romapi_qcc74x_pwm_v2_get_intstatus
    return romapi_qcc74x_pwm_v2_get_intstatus(dev);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_pwm_v2_feature_control
    return romapi_qcc74x_pwm_v2_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t regval;
