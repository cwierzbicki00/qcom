#ifndef _QCC74x_SF_CTRL_H
#define _QCC74x_SF_CTRL_H
...
#ifdef QCC74x_SF_CTRL_HAS_SAHB_CLOCK
    uint8_t sahb_clock;                  /*!< Sflash clock sahb sram select */
#endif
#ifdef QCC74x_SF_CTRL_HAS_AHB2SIF_MODE
...
#ifdef QCC74x_SF_CTRL_PSRAM_ENABLE
/**
...
#endif
#ifdef QCC74x_SF_CTRL_PSRAM_ENABLE
void qcc74x_sf_ctrl_psram_init(struct sf_ctrl_psram_cfg *psram_cfg);
#endif
...
#ifdef QCC74x_SF_CTRL_AES_XTS_ENABLE
...
#endif
#ifdef QCC74x_SF_CTRL_PSRAM_ENABLE
void qcc74x_sf_ctrl_psram_write_set(struct sf_ctrl_cmd_cfg_type *cfg, uint8_t cmd_valid);
