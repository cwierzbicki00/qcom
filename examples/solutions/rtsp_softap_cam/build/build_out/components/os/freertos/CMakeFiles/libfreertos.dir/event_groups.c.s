...
.LVL2:
	...
	call	printf
.LVL3:
	.loc 1 86 153 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,86
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL4:
	.loc 1 86 182 discriminator 1
	lui	a1,%hi(.LC4)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC4)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL5:
	.loc 1 86 238 discriminator 1
	call	vAssertCalled
.LVL6:
.L2:
	.loc 1 86 256 discriminator 3
.LBB2:
...
.LVL7:
	...
	call	printf
.LVL8:
	.loc 1 94 170 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,94
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL9:
	.loc 1 94 199 discriminator 1
	lui	a1,%hi(.LC6)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC6)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL10:
	.loc 1 94 268 discriminator 1
	call	vAssertCalled
.LVL11:
.L3:
	.loc 1 94 286 discriminator 3
.LBE2:
...
.LVL23:
	...
	call	printf
.LVL24:
	.loc 1 315 142 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,315
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL25:
	.loc 1 315 172 discriminator 1
	lui	a1,%hi(.LC7)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC7)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL26:
	.loc 1 315 221 discriminator 1
	call	vAssertCalled
.LVL27:
.L16:
	.loc 1 315 239 discriminator 3
...
.LVL28:
	...
	call	printf
.LVL29:
	.loc 1 316 170 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,316
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL30:
	.loc 1 316 200 discriminator 1
	lui	a1,%hi(.LC8)
	addi	a1,a1,%lo(.LC8)
.L51:
	.loc 1 317 181 is_stmt 0 discriminator 1
	lui	a0,%hi(.LC5)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL31:
	.loc 1 317 239 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL32:
.L18:
	.loc 1 317 257 discriminator 3
...
.L17:
.LBE8:
	.loc 1 316 312 is_stmt 1 discriminator 3
...
.LVL47:
	...
	call	printf
.LVL48:
	.loc 1 317 151 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,317
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL49:
	.loc 1 317 181 discriminator 1
	lui	a1,%hi(.LC9)
	addi	a1,a1,%lo(.LC9)
	j	.L51
.LVL50:
...
.LVL53:
 ...
 #APP
# 398 "C:\Users\cwier\Documents\GitHub\qcom\components\os\freertos\event_groups.c" 1
	ecall
# 0 "" 2
	.loc 1 398 39
 #NO_APP
...
.LVL72:
	...
	call	printf
.LVL73:
	.loc 1 466 142 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,466
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL74:
	.loc 1 466 172 discriminator 1
	lui	a1,%hi(.LC7)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC7)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL75:
	.loc 1 466 221 discriminator 1
	call	vAssertCalled
.LVL76:
.L53:
	.loc 1 466 239 discriminator 3
...
.LVL77:
	...
	call	printf
.LVL78:
	.loc 1 467 168 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,467
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL79:
	.loc 1 467 198 discriminator 1
	lui	a1,%hi(.LC11)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC11)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL80:
	.loc 1 467 290 discriminator 1
	call	vAssertCalled
.LVL81:
.L54:
	.loc 1 467 308 discriminator 3
...
.LVL100:
	...
	call	printf
.LVL101:
	.loc 1 531 142 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,531
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL102:
	.loc 1 531 172 discriminator 1
	lui	a1,%hi(.LC7)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC7)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL103:
	.loc 1 531 221 discriminator 1
	call	vAssertCalled
.LVL104:
.L63:
	.loc 1 531 239 discriminator 3
...
.LVL105:
	...
	call	printf
.LVL106:
	.loc 1 532 166 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,532
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL107:
	.loc 1 532 196 discriminator 1
	lui	a1,%hi(.LC12)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC12)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL108:
	.loc 1 532 286 discriminator 1
	call	vAssertCalled
.LVL109:
.L64:
	.loc 1 532 304 discriminator 3
...
.LVL132:
	...
	call	printf
.LVL133:
	.loc 1 189 170 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,189
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL134:
	.loc 1 189 200 discriminator 1
	lui	a1,%hi(.LC8)
	addi	a1,a1,%lo(.LC8)
.L96:
	.loc 1 190 181 is_stmt 0 discriminator 1
	lui	a0,%hi(.LC5)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL135:
	.loc 1 190 239 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL136:
.L80:
	.loc 1 190 257 discriminator 3
...
.LVL150:
 ...
 #APP
# 246 "C:\Users\cwier\Documents\GitHub\qcom\components\os\freertos\event_groups.c" 1
	ecall
# 0 "" 2
	.loc 1 246 39
 #NO_APP
...
.L79:
	.cfi_restore_state
	.loc 1 189 312 is_stmt 1 discriminator 3
...
.LVL164:
	...
	call	printf
.LVL165:
	.loc 1 190 151 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,190
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL166:
	.loc 1 190 181 discriminator 1
	lui	a1,%hi(.LC9)
	addi	a1,a1,%lo(.LC9)
	j	.L96
.L82:
...
.LVL174:
	...
	call	printf
.LVL175:
	.loc 1 619 142 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,619
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL176:
	.loc 1 619 172 discriminator 1
	lui	a1,%hi(.LC13)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC13)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL177:
	.loc 1 619 221 discriminator 1
	call	vAssertCalled
.LVL178:
.L99:
	.loc 1 619 239 discriminator 3
...
.LVL179:
	...
	lui	s2,%hi(.LC0)
	lui	s3,%hi(.LC1)
	.loc 1 631 201 discriminator 3
	lui	s4,%hi(.LANCHOR5)
	lui	s5,%hi(.LC2)
	.loc 1 631 240 discriminator 3
	lui	s6,%hi(.LC3)
	.loc 1 631 270 discriminator 3
	lui	s7,%hi(.LC14)
	lui	s8,%hi(.LC5)
.L100:
...
.L102:
	...
	call	printf
.LVL183:
	.loc 1 631 201 discriminator 1
	addi	a1,s4,%lo(.LANCHOR5)
	addi	a0,s5,%lo(.LC2)
	call	printf
.LVL184:
	.loc 1 631 240 discriminator 1
	li	a1,631
	addi	a0,s6,%lo(.LC3)
	call	printf
.LVL185:
	.loc 1 631 270 discriminator 1
	addi	a1,s7,%lo(.LC14)
	addi	a0,s8,%lo(.LC5)
	call	printf
.LVL186:
	.loc 1 631 409 discriminator 1
	call	vAssertCalled
.LVL187:
.L101:
	.loc 1 631 427 discriminator 3
...
.LVL194:
	...
	call	printf
.LVL195:
	.loc 1 667 146 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,667
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL196:
	.loc 1 667 176 discriminator 1
	lui	a1,%hi(.LC13)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC13)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL197:
	.loc 1 667 225 discriminator 1
	call	vAssertCalled
.LVL198:
.L106:
	.loc 1 667 243 discriminator 3
...
.LVL199:
	...
	call	printf
.LVL200:
	.loc 1 668 154 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,668
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL201:
	.loc 1 668 184 discriminator 1
	lui	a1,%hi(.LC15)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC15)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL202:
	.loc 1 668 241 discriminator 1
	call	vAssertCalled
.LVL203:
.L107:
	.loc 1 668 259 discriminator 3
