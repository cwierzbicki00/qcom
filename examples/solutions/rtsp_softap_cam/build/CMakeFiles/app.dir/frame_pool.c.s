...
pool_sem_put:
.LFB82:
	.file 1 ".\\examples\\solutions\\rtsp_softap_cam\\frame_pool.c"
	.loc 1 62 1
	.cfi_startproc
	.loc 1 63 5
	lui	a5,%hi(.LANCHOR0)
...
.LFE83:
	...
	.align	2
.LC5:
	.string	".\\examples\\solutions\\rtsp_softap_cam\\frame_pool.c"
	.align	2
.LC6:
	.string	"file [%s]\r\n"
	.align	2
...
.LVL23:
	...
	call	printf
.LVL24:
	.loc 1 123 231 discriminator 1
	call	vAssertCalled
.LVL25:
.L18:
	.loc 1 123 249 discriminator 3
...
.LVL26:
	...
	call	printf
.LVL27:
	.loc 1 124 135 discriminator 1
	lui	a0,%hi(.LC8)
	li	a1,124
	addi	a0,a0,%lo(.LC8)
	call	printf
.LVL28:
	.loc 1 124 165 discriminator 1
	lui	a1,%hi(.LC11)
	lui	a0,%hi(.LC10)
	addi	a1,a1,%lo(.LC11)
	addi	a0,a0,%lo(.LC10)
	call	printf
.LVL29:
	.loc 1 124 216 discriminator 1
	call	vAssertCalled
.LVL30:
.L19:
	.loc 1 124 234 discriminator 3
...
.L46:
.LVL52:
	.loc 1 179 5 is_stmt 1 discriminator 4
	.loc 1 179 9 is_stmt 0 discriminator 4
	lui	a5,%hi(.LANCHOR4)
	mv	a1,a0
.LVL53:
...
.LVL54:
	call	xQueueReceive
.LVL55:
	.loc 1 183 1 discriminator 4
	lw	ra,12(sp)
	.cfi_restore 1
	.loc 1 179 8 discriminator 4
	addi	a0,a0,-1
	snez	a0,a0
	.loc 1 183 1 discriminator 4
	neg	a0,a0
...
.LVL56:
	...
	.loc 1 187 46
	beq	a1,zero,.L52
	.loc 1 187 99 discriminator 1
	li	a5,1000
	mul	a2,a1,a5
	.loc 1 187 46 discriminator 1
	divu	a2,a2,a5
.L52:
.LVL57:
	...
	.loc 1 191 9 is_stmt 0 discriminator 4
	lui	s1,%hi(.LANCHOR4)
...
.LVL84:
	...
	beq	s1,zero,.L82
	.loc 1 249 20 is_stmt 1 discriminator 1
	.loc 1 249 27 is_stmt 0 discriminator 1
	lw	a5,8(sp)
	sw	a5,0(s1)
.L82:
	...
	beq	s0,zero,.L81
	.loc 1 250 25 is_stmt 1 discriminator 1
	.loc 1 250 37 is_stmt 0 discriminator 1
	lw	a5,12(sp)
	sw	a5,0(s0)
.L81:
.LBE3:
...
.Letext0:
	...
	.file 4 ".\\examples\\solutions\\rtsp_softap_cam\\frame_pool.h"
	...
	.file 10 ".\\examples\\solutions\\rtsp_softap_cam\\freertosconfig.h"
	.file 11 "<built-in>"
