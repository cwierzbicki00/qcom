...
.Ltext0:
	...
	.align	2
.LC0:
	.string	"\033[0;31m[E][MAIN] RTSP server start failed\r\n"
	.align	2
.LC1:
	.string	"192.168.2.1"
	.align	2
.LC2:
	.string	"\033[0m[I][MAIN] RTSP ready: rtsp://%s:8554/\r\n"
	.align	2
.LC3:
	.string	"\033[0m[I][MAIN] Snapshot URL: http://%s/snapshot.jpg\r\n"
	.section	.text.app_task,"ax",@progbits
	.align	1
	.type	app_task, @function
app_task:
.LFB357:
	.file 1 ".\\examples\\solutions\\rtsp_softap_cam\\main.c"
	.loc 1 74 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-48
...
.LVL4:
	.loc 1 91 17
	.loc 1 91 21 is_stmt 0
	call	rtsp_bridge_start
.LVL5:
	.loc 1 91 20
	beq	a0,zero,.L9
...
.LC14:
	...
	.align	2
.LC15:
	.string	"\033[0m[I][MAIN] FW: rtsp-softap-cam v0.1.0 (unknown) built %s %s\r\n"
	.align	2
.LC16:
...
.LC27:
	...
	.align	2
.LC28:
	.string	"\033[0m[I][MAIN] SoftAP SSID: %s\r\n"
	.align	2
.LC29:
	.string	"\033[0m[I][MAIN] SoftAP IP: %s\r\n"
	.align	2
.LC30:
	.string	"\033[0m[I][MAIN] RTSP URL: rtsp://%s:8554/\r\n"
	.align	2
.LC31:
	.string	"\033[0m[I][MAIN] Camera: waiting for USB UVC MJPEG device\r\n"
	.align	2
.LC32:
...
.LVL39:
	...
	addi	a1,a1,%lo(.LC12)
.L30:
	.loc 1 168 168 discriminator 4
	lw	a2,44(sp)
	.loc 1 168 9 discriminator 4
	bne	a2,zero,.L31
	.loc 1 168 9
	lui	a2,%hi(.LC12)
	addi	a2,a2,%lo(.LC12)
.L31:
	.loc 1 168 227 discriminator 8
	lw	a3,40(sp)
	.loc 1 168 9 discriminator 8
	bne	a3,zero,.L32
	.loc 1 168 9
	lui	a3,%hi(.LC12)
	addi	a3,a3,%lo(.LC12)
.L32:
	.loc 1 168 9 discriminator 12
	lbu	a4,31(sp)
	lui	a0,%hi(.LC16)
	addi	a0,a0,%lo(.LC16)
	call	printf
.LVL40:
	.loc 1 173 9 is_stmt 1 discriminator 12
	.loc 1 173 101 is_stmt 0 discriminator 12
	call	kfree_size
.LVL41:
	sw	a0,12(sp)
	.loc 1 173 125 discriminator 12
	call	pfree_size
.LVL42:
	.loc 1 173 9 discriminator 12
	lw	a1,12(sp)
	.loc 1 173 125 discriminator 12
	mv	a2,a0
	.loc 1 173 9 discriminator 12
...
.LVL43:
.LBE5:
	.loc 1 177 5 is_stmt 1 discriminator 12
	.loc 1 177 13 is_stmt 0 discriminator 12
	lui	a0,%hi(.LC18)
	addi	a0,a0,%lo(.LC18)
	call	qcc74x_device_get_by_name
.LVL44:
	.loc 1 178 5 is_stmt 1 discriminator 12
	call	shell_init_with_task
.LVL45:
	.loc 1 180 5 discriminator 12
	.loc 1 180 14 is_stmt 0 discriminator 12
	li	a2,0
	li	a1,0
	li	a0,0
	call	rfparam_init
.LVL46:
	.loc 1 180 8 discriminator 12
	beq	a0,zero,.L33
...
.Letext0:
	...
	.file 17 ".\\drivers\\soc\\qcc743\\std\\include/qcc743_glb.h"
	.file 18 ".\\bsp\\board\\qcc74xdk\\board.h"
	.file 19 ".\\drivers\\rfparam\\Inc/rfparam_adapter.h"
	.file 20 ".\\examples\\solutions\\rtsp_softap_cam\\frame_pool.h"
	.file 21 ".\\components\\net\\lwip\\lwip\\src\\include/lwip/tcpip.h"
	.file 22 ".\\examples\\solutions\\rtsp_softap_cam\\uvc_capture.h"
	.file 23 ".\\components\\wireless\\wifi6\\qcc74x_fhost\\include/wifi_mgmr.h"
	.file 24 ".\\examples\\solutions\\rtsp_softap_cam\\wifi_ap.h"
	.file 25 ".\\examples\\solutions\\rtsp_softap_cam\\http_server.h"
	.file 26 ".\\examples\\solutions\\rtsp_softap_cam\\rtsp_bridge.h"
...
.LASF225:
	.string	".\\examples\\solutions\\rtsp_softap_cam\\main.c"
.LASF48:
	.string	"AC_MAX"
.LASF115:
