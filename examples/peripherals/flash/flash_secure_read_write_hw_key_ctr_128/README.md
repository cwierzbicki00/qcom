...
For the sec eng AES module key location, please refer to ``QCC743/QCC744 Secure Boot Application Note``

For this case, the application is non-encrypted. According to ``QCC743/QCC744 Secure Boot Application Note``, the optional keys for sec eng are as follows:
...
```
./QConn_Flash_Cmd.exe --interface=uart --port=COM16 --baudrate=500000 --efuse=E:/examples/peripherals/flash/flash_secure_read_write_hw_key_ctr_128/efusedata.bin
```
## Flash
