...
.LC1:
	...
	.align	2
.LC2:
	.string	"\033[0m[I][MAIN] [CONNECT] SSID=%s IP=%s URL=http://%s/ SNAPSHOT=http://%s/snapshot.jpg\r\n"
...
.LVL43:
	...
	addi	a1,a1,%lo(.LC14)
.L31:
	.loc 1 167 168 discriminator 4
	lw	a2,44(sp)
	.loc 1 167 9 discriminator 4
	bne	a2,zero,.L32
	.loc 1 167 9
	lui	a2,%hi(.LC14)
	addi	a2,a2,%lo(.LC14)
.L32:
	.loc 1 167 227 discriminator 8
	lw	a3,40(sp)
	.loc 1 167 9 discriminator 8
	bne	a3,zero,.L33
	.loc 1 167 9
	lui	a3,%hi(.LC14)
	addi	a3,a3,%lo(.LC14)
.L33:
	.loc 1 167 9 discriminator 12
	lbu	a4,31(sp)
	lui	a0,%hi(.LC18)
	addi	a0,a0,%lo(.LC18)
	call	printf
.LVL44:
	.loc 1 172 9 is_stmt 1 discriminator 12
	.loc 1 172 101 is_stmt 0 discriminator 12
	call	kfree_size
.LVL45:
	sw	a0,12(sp)
	.loc 1 172 125 discriminator 12
	call	pfree_size
.LVL46:
	.loc 1 172 9 discriminator 12
	lw	a1,12(sp)
	.loc 1 172 125 discriminator 12
	mv	a2,a0
	.loc 1 172 9 discriminator 12
...
.LVL47:
.LBE2:
	.loc 1 176 5 is_stmt 1 discriminator 12
	.loc 1 176 13 is_stmt 0 discriminator 12
	lui	a0,%hi(.LC20)
	addi	a0,a0,%lo(.LC20)
...
.LVL49:
	.loc 1 179 5 discriminator 12
	.loc 1 179 14 is_stmt 0 discriminator 12
	li	a2,0
	li	a1,0
	li	a0,0
	call	rfparam_init
.LVL50:
	.loc 1 179 8 discriminator 12
	beq	a0,zero,.L34
