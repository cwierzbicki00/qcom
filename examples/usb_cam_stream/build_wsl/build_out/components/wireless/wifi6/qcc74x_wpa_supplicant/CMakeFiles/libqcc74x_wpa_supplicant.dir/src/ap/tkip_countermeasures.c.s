...
.Ltext0:
	...
	.section	.text.hostapd_drv_set_countermeasures.isra.0,"ax",@progbits
	.align	1
	.type	hostapd_drv_set_countermeasures.isra.0, @function
hostapd_drv_set_countermeasures.isra.0:
.LFB206:
...
.L1:
	...
	.cfi_endproc
.LFE206:
	.size	hostapd_drv_set_countermeasures.isra.0, .-hostapd_drv_set_countermeasures.isra.0
	.section	.text.ieee80211_tkip_countermeasures_stop,"ax",@progbits
	.align	1
	.type	ieee80211_tkip_countermeasures_stop, @function
ieee80211_tkip_countermeasures_stop:
.LFB202:
	.file 2 "./components/wireless/wifi6/qcc74x_wpa_supplicant/src/ap/tkip_countermeasures.c"
	.loc 2 25 1 is_stmt 1
	.cfi_startproc
.LVL3:
	.loc 2 26 2
	.loc 2 27 2
	.loc 2 27 29 is_stmt 0
	sw	zero,1384(a0)
	.loc 2 28 2 is_stmt 1
	li	a1,0
.LVL4:
	tail	hostapd_drv_set_countermeasures.isra.0
.LVL5:
	.cfi_endproc
.LFE202:
	.size	ieee80211_tkip_countermeasures_stop, .-ieee80211_tkip_countermeasures_stop
	.section	.text.ieee80211_tkip_countermeasures_deinit,"ax",@progbits
	.align	1
	.globl	ieee80211_tkip_countermeasures_deinit
	.type	ieee80211_tkip_countermeasures_deinit, @function
...
.LVL6:
	...
	mv	a1,a0
	.loc 2 65 2
	lui	a0,%hi(ieee80211_tkip_countermeasures_stop)
.LVL7:
	li	a2,0
	addi	a0,a0,%lo(ieee80211_tkip_countermeasures_stop)
	tail	eloop_cancel_timeout
.LVL8:
	.cfi_endproc
.LFE204:
	.size	ieee80211_tkip_countermeasures_deinit, .-ieee80211_tkip_countermeasures_deinit
	.section	.text.michael_mic_failure,"ax",@progbits
	.align	1
	.globl	michael_mic_failure
	.type	michael_mic_failure, @function
michael_mic_failure:
.LFB205:
...
.LVL10:
	...
	.loc 2 93 11 is_stmt 0
	li	a5,0
	.loc 2 81 6
	beq	a0,zero,.L11
	.loc 2 82 4 is_stmt 1
	lw	a0,148(a0)
.LVL11:
	call	wpa_auth_sta_local_mic_failure_report
.LVL12:
	.loc 2 83 4
	.loc 2 83 9
	.loc 2 83 17
	...
	mv	a1,s1
	mv	a0,s0
	call	mlme_michaelmicfailure_indication
.LVL13:
.L12:
.LBE9:
	.loc 2 97 2
...
.LBE11:
.LBE10:
	.loc 2 99 3 is_stmt 1
	.loc 2 99 30 is_stmt 0
	li	a5,1
.LVL20:
	sw	a5,1380(s0)
	.loc 2 72 6
...
.LBB17:
	...
	li	s2,6
	.loc 2 41 2
	call	wpa_auth_countermeasures_start
.LVL29:
	.loc 2 42 2 is_stmt 1
	.loc 2 43 2 is_stmt 0
	li	a1,1
	.loc 2 42 29
	sw	s1,1384(s0)
	.loc 2 43 2 is_stmt 1
	mv	a0,s0
	call	hostapd_drv_set_countermeasures.isra.0
.LVL30:
	.loc 2 44 2
	lw	a0,1356(s0)
	.loc 2 45 2 is_stmt 0
	lui	s1,%hi(ieee80211_tkip_countermeasures_stop)
	.loc 2 44 2
	call	wpa_gtk_rekey
.LVL31:
	...
	li	a2,0
	mv	a1,s0
	addi	a0,s1,%lo(ieee80211_tkip_countermeasures_stop)
	call	eloop_cancel_timeout
.LVL32:
	.loc 2 46 2
	li	a4,0
	mv	a3,s0
	addi	a2,s1,%lo(ieee80211_tkip_countermeasures_stop)
	li	a1,0
	li	a0,60
...
.LBB18:
	j	.L16
.L21:
	.loc 2 49 3 is_stmt 1
	.loc 2 51 18 is_stmt 0
	lw	a5,32(s1)
	.loc 2 49 29
	sw	s2,116(s1)
...
.LBE19:
	.cfi_endproc
.LFE205:
	.size	michael_mic_failure, .-michael_mic_failure
	.text
.Letext0:
	...
	.file 27 "./components/wireless/wifi6/qcc74x_wpa_supplicant/src/ap/ap_mlme.h"
	.file 28 "./components/wireless/wifi6/qcc74x_wpa_supplicant/src/utils/eloop.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	ieee80211_tkip_countermeasures_stop
	.byte	0x36
	.byte	0x1
	.byte	0x5b
	.byte	0x2
...
.LASF320:
	.string	"secpolicy"
.LASF1539:
	.string	"hostapd_drv_set_countermeasures"
.LASF1341:
	.string	"cac_started"
.LASF213:
...
.LASF779:
	.string	"set_frag"
.LASF1556:
	.string	"./components/wireless/wifi6/qcc74x_wpa_supplicant/src/ap/tkip_countermeasures.c"
.LASF1435:
...
.LASF1279:
	.string	"probereq_cb"
.LASF1542:
	.string	"ieee80211_tkip_countermeasures_start"
.LASF193:
	.string	"encr_type"
.LASF346:
	.string	"configured"
...
.LASF1014:
	.string	"head_len"
.LASF1560:
	.string	"ieee80211_tkip_countermeasures_stop"
.LASF1086:
