...
.LBB14:
	.loc 1 248 24
 #APP
# 248 "/mnt/c/Users/cwier/documents/github/qcom/components/wireless/wifi6/qcc74x_os_adapter/src/rtos_al.c" 1
	csrrci s0, mstatus, 8
# 0 "" 2
.LVL56:
...
.LVL57:
 ...
 #APP
# 250 "/mnt/c/Users/cwier/documents/github/qcom/components/wireless/wifi6/qcc74x_os_adapter/src/rtos_al.c" 1
	csrw mstatus, s0
# 0 "" 2
 #NO_APP
.LBE14:
...
.LBB16:
	.loc 1 259 24
 #APP
# 259 "/mnt/c/Users/cwier/documents/github/qcom/components/wireless/wifi6/qcc74x_os_adapter/src/rtos_al.c" 1
	csrrci s0, mstatus, 8
# 0 "" 2
.LVL62:
...
.LVL63:
 ...
 #APP
# 261 "/mnt/c/Users/cwier/documents/github/qcom/components/wireless/wifi6/qcc74x_os_adapter/src/rtos_al.c" 1
	csrw mstatus, s0
# 0 "" 2
 #NO_APP
.LBE16:
...
.LVL141:
	...
	call	printf
.LVL142:
	.loc 1 443 151 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,443
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL143:
	.loc 1 443 181 discriminator 1
	lui	a1,%hi(.LC4)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC4)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL144:
	.loc 1 443 223 discriminator 1
	call	vAssertCalled
.LVL145:
	lw	a2,12(sp)
.LVL146:
.L100:
	.loc 1 443 241 discriminator 3
...
.Letext0:
	...
	.file 9 "./examples/usb_cam_stream/./FreeRTOSConfig.h"
...
.LASF176:
	.string	"./examples/usb_cam_stream/build_wsl/build_out/components/wireless/wifi6/qcc74x_os_adapter"
.LASF38:
