...
.LVL0:
	...
	.loc 1 146 9
 #APP
# 146 "/mnt/c/Users/cwier/documents/github/qcom/components/os/freertos/portable/GCC/RISC-V/common/port.c" 1
	csrr a5, mhartid
# 0 "" 2
 #NO_APP
	sw	a5,12(sp)
...
.LBB3:
 ...
 #APP
# 178 "/mnt/c/Users/cwier/documents/github/qcom/components/os/freertos/portable/GCC/RISC-V/common/port.c" 1
	csrr a5, mtvec
# 0 "" 2
 #NO_APP
	sw	a5,12(sp)
...
.LVL6:
	...
	call	printf
.LVL7:
	.loc 1 179 176 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,179
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL8:
	.loc 1 179 206 discriminator 1
	lui	a1,%hi(.LC4)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC4)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL9:
	.loc 1 179 270 discriminator 1
	call	vAssertCalled
.LVL10:
.L6:
	.loc 1 179 288 discriminator 3
...
.LVL11:
	...
	call	printf
.LVL12:
	.loc 1 184 184 discriminator 1
	lui	a0,%hi(.LC3)
	li	a1,184
	addi	a0,a0,%lo(.LC3)
	call	printf
.LVL13:
	.loc 1 184 214 discriminator 1
	lui	a1,%hi(.LC6)
	lui	a0,%hi(.LC5)
	addi	a1,a1,%lo(.LC6)
	addi	a0,a0,%lo(.LC5)
	call	printf
.LVL14:
	.loc 1 184 299 discriminator 1
	call	vAssertCalled
.LVL15:
.L7:
	.loc 1 184 317 discriminator 3
.LBE3:
...
.LVL16:
	...
	addi	a5,a5,-1920
 #APP
# 204 "/mnt/c/Users/cwier/documents/github/qcom/components/os/freertos/portable/GCC/RISC-V/common/port.c" 1
	csrs mie, a5
# 0 "" 2
...
.Letext0:
	...
	.file 7 "./examples/usb_cam_stream/./FreeRTOSConfig.h"
