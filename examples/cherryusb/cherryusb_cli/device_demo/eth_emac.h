...
extern int eth_emac_tx_buff_get(struct qcc74x_emac_trans_desc_s *trans_desc, uint32_t timeout);
extern int eth_emac_tx_buff_push(struct qcc74x_emac_trans_desc_s *trans_desc);
extern int eth_emac_rx_data_get(struct qcc74x_emac_trans_desc_s *trans_desc, uint32_t timeout);
extern int eth_emac_rx_data_free(struct qcc74x_emac_trans_desc_s *trans_desc);
