...
/* Relevant configurations need to be adjusted in the board or the app configuration file */
//#define PA_PIN                 4
...
{
    snd_qcc743_config_t snd_config;
    ...
    snd_card_qcc743_register(&snd_config);
}
