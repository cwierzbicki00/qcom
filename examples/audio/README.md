...
| player      | Extensive audio playback capabilities | Player-related Demo, planning to support audio streaming from memory, flash, SD card, WiFi, Currently supports memory and flash playback, also supports WiFi.    |
